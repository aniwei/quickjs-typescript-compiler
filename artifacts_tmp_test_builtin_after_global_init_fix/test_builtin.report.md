...
- 偏移量 0x1394: TS=0x15 vs WASM=0x3c
- 偏移量 0x1395: TS=0x3c vs WASM=0x8b
- 偏移量 0x1396: TS=0x8b vs WASM=0x00
- 偏移量 0x1399: TS=0x00 vs WASM=0x29
- 偏移量 0x139a: TS=0x29 vs WASM=0x94
- 偏移量 0x139b: TS=0x94 vs WASM=0x04
- 偏移量 0x139c: TS=0x04 vs WASM=0x16
- 偏移量 0x139d: TS=0x16 vs WASM=0x06
- 偏移量 0x139e: TS=0x06 vs WASM=0x00
- 偏移量 0x139f: TS=0x00 vs WASM=0x03
- 偏移量 0x13a0: TS=0x03 vs WASM=0x10
- 偏移量 0x13a1: TS=0x10 vs WASM=0x26
- 偏移量 0x13a2: TS=0x26 vs WASM=0x0c
- 偏移量 0x13a3: TS=0x0c vs WASM=0x1b
- 偏移量 0x13a4: TS=0x1b vs WASM=0x0c
- 偏移量 0x13a5: TS=0x0c vs WASM=0x07
- 偏移量 0x13a6: TS=0x07 vs WASM=0x01
- 偏移量 0x13a7: TS=0x01 vs WASM=0x07
- 偏移量 0x13a8: TS=0x07 vs WASM=0x15
- ... (显示前20个差异，总共57117个)
...
00001390: 00 00 00 b8 15 3c 8b 00 00 00 29 94 04 16 06 00 |.....<....).....|
