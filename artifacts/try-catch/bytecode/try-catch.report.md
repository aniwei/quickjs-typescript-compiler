...
- 偏移量 0x5c: TS=0x5e vs WASM=0x02
- 偏移量 0x5d: TS=0x6f vs WASM=0x29
- 偏移量 0x5e: TS=0x1d vs WASM=0x6f
- 偏移量 0x5f: TS=0x00 vs WASM=0x1d
...
- 偏移量 0x6c: TS=0x04 vs WASM=0x00
- 偏移量 0x6d: TS=0x18 vs WASM=0x04
- 偏移量 0x6e: TS=0x00 vs WASM=0x18
- 偏移量 0x71: TS=0x24 vs WASM=0x00
- 偏移量 0x72: TS=0x01 vs WASM=0x24
- 偏移量 0x73: TS=0x00 vs WASM=0x01
- 偏移量 0x74: TS=0x0e vs WASM=0x00
- 偏移量 0x75: TS=0x04 vs WASM=0x0e
- 偏移量 0x76: TS=0xe8 vs WASM=0x04
- 偏移量 0x77: TS=0x00 vs WASM=0xe8
- ... (显示前20个差异，总共66个)
...
00000050: 05 00 00 62 01 ca 03 03 00 03 08 ec 5e 6f 1d 00 |...b........^o..|
00000060: 00 00 39 e6 00 00 00 43 e7 00 00 00 04 18 00 00 |..9....C........|
00000070: 00 24 01 00 0e 04 e8 00 00 00 30 cb 6f 22 00 00 |.$........0.o"..|
00000080: 00 39 e6 00 00 00 43 e7 00 00 00 04 19 00 00 00 |.9....C.........|
00000090: c7 24 02 00 0e 0e 06 70 0d 00 00 00 0e ee 1b 70 |.$.....p.......p|
000000a0: 05 00 00 00 30 39 e6 00 00 00 43 e7 00 00 00 04 |....09....C.....|
000000b0: 1a 00 00 00 24 01 00 0e 71 29 06 2f c8 03 18 00 |....$...q)./....|
000000c0: 00 2b 08 1b 0e 34 08 30 15 28 00 1b 0e 34 1c 07 |.+...4.0.(...4..|
