...
- 偏移量 0xbe: TS=0x0c vs WASM=0x18
- 偏移量 0xc3: TS=0x7b vs WASM=0x1b
- 偏移量 0xc4: TS=0x00 vs WASM=0x0e
- 偏移量 0xc5: TS=0x28 vs WASM=0x34
- 偏移量 0xc6: TS=0x00 vs WASM=0x08
- 偏移量 0xc7: TS=0x4d vs WASM=0x30
- 偏移量 0xc8: TS=0x2a vs WASM=0x15
- 偏移量 0xc9: TS=0x6e vs WASM=0x28
- 偏移量 0xca: TS=0x29 vs WASM=0x00
- 偏移量 0xcb: TS=0x00 vs WASM=0x1b
- 偏移量 0xcc: TS=EOF vs WASM=0x0e
- 偏移量 0xcd: TS=EOF vs WASM=0x34
- 偏移量 0xce: TS=EOF vs WASM=0x1c
- 偏移量 0xcf: TS=EOF vs WASM=0x07
- 偏移量 0xd0: TS=EOF vs WASM=0x13
- 偏移量 0xd1: TS=EOF vs WASM=0x69
- 偏移量 0xd2: TS=EOF vs WASM=0x15
- 偏移量 0xd3: TS=EOF vs WASM=0x1b
- 偏移量 0xd4: TS=EOF vs WASM=0x0e
- 偏移量 0xd5: TS=EOF vs WASM=0x34
- ... (显示前20个差异，总共22个)
...
000000b0: 04 1a 00 00 00 24 01 00 0e 71 06 2f c8 03 0c 00 |.....$...q./....|
000000c0: 00 30 08 7b 00 28 00 4d 2a 6e 29 00             |.0.{.(.M*n).|
```
