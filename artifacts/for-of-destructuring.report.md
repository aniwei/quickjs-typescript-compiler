...
**输入文件**: __tests__/fixtures/for-of-destructuring.ts
**生成时间**: 2025-12-23T10:14:46.360Z
...
- 偏移量 0x106: TS=0x22 vs WASM=0x24
- 偏移量 0x11d: TS=0x4e vs WASM=0x2a
- 偏移量 0x11e: TS=0x03 vs WASM=0x09
- 偏移量 0x11f: TS=0x20 vs WASM=0x26
- 偏移量 0x120: TS=0x04 vs WASM=0x06
- 偏移量 0x121: TS=0x32 vs WASM=0x20
- 偏移量 0x122: TS=0x13 vs WASM=0x04
- 偏移量 0x123: TS=0x1b vs WASM=0x32
- 偏移量 0x124: TS=0x0e vs WASM=0x13
- 偏移量 0x126: TS=0x0a vs WASM=0x0e
- 偏移量 0x128: TS=0x01 vs WASM=0x0a
- 偏移量 0x129: TS=0x00 vs WASM=0x1b
- 偏移量 0x12a: TS=EOF vs WASM=0x01
- 偏移量 0x12b: TS=EOF vs WASM=0x00
...
00000100: 01 00 cf 28 d4 03 22 00 00 00 3a 06 1c 30 13 1b |...(.."...:..0..|
00000110: 0e 11 05 4a 0f 1b 0e 1b 0a 1b 01 40 01 4e 03 20 |...J.......@.N. |
00000120: 04 32 13 1b 0e 1b 0a 1b 01 00                   |.2........|
```
