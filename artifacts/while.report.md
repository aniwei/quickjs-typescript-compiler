...
**输入文件**: __tests__/compiler/fixtures/while.ts
**生成时间**: 2025-12-08T16:50:57.008Z

## 大小对比

- TypeScript编译器: 141 字节
- WASM编译器: 143 字节
- 差异: -2 字节 (-1.40%)
...
- 偏移量 0x7b: TS=0x10 vs WASM=0x12
- 偏移量 0x7f: TS=0x07 vs WASM=0x0e
- 偏移量 0x81: TS=0x02 vs WASM=0x04
- 偏移量 0x83: TS=0x7b vs WASM=0x09
- 偏移量 0x85: TS=0x07 vs WASM=0x0e
- 偏移量 0x87: TS=0x05 vs WASM=0x0a
- 偏移量 0x89: TS=0x7f vs WASM=0x01
- 偏移量 0x8b: TS=0x75 vs WASM=0x15
- 偏移量 0x8c: TS=0x00 vs WASM=0x11
...
00000070: 93 69 00 00 0e ee df 06 2f c8 03 10 00 00 21 07 |.i....../.....!.|
00000080: 16 02 12 7b 1b 07 1b 05 11 7f 17 75 00          |...{.......u.|
```
