...
- 偏移量 0x9e: TS=0x34 vs WASM=0x1b
- 偏移量 0x9f: TS=0x18 vs WASM=0x0e
- 偏移量 0xa0: TS=0x11 vs WASM=0x1b
- 偏移量 0xa1: TS=0x02 vs WASM=0x0a
- 偏移量 0xa2: TS=0x00 vs WASM=0x11
- 偏移量 0xa3: TS=EOF vs WASM=0x02
...
00000090: 01 00 0e 06 2f c8 03 0a 00 00 44 1e 4e 1d 34 18 |..../.....D.N.4.|
000000a0: 11 02 00                                        |...|
```
