...
**输入文件**: __tests__/compiler/fixtures/es2020_bigint_large.ts
**生成时间**: 2025-12-08T13:55:42.372Z
...
- 偏移量 0x94: TS=0x16 vs WASM=0x14
- 偏移量 0x97: TS=0x16 vs WASM=0x30
- 偏移量 0x99: TS=0x12 vs WASM=0x0d
- 偏移量 0x9a: TS=0x02 vs WASM=0x13
- 偏移量 0x9b: TS=0x17 vs WASM=0x1b
- 偏移量 0x9c: TS=0x15 vs WASM=0x0e
- 偏移量 0x9e: TS=0x0e vs WASM=0x0a
- 偏移量 0x9f: TS=0x1b vs WASM=0x11
- 偏移量 0xa0: TS=0x0a vs WASM=0x01
- 偏移量 0xa1: TS=0x11 vs WASM=0x17
- 偏移量 0xa2: TS=0x01 vs WASM=0x15
- 偏移量 0xa3: TS=0x17 vs WASM=0x1b
- 偏移量 0xa4: TS=0x15 vs WASM=0x0e
- 偏移量 0xa6: TS=0x0e vs WASM=0x0a
- 偏移量 0xa7: TS=0x1b vs WASM=0x11
- 偏移量 0xa8: TS=0x0a vs WASM=0x01
- 偏移量 0xa9: TS=0x11 vs WASM=0x00
- 偏移量 0xaa: TS=0x01 vs WASM=0x0a
- 偏移量 0xab: TS=0x00 vs WASM=0x05
- ... (显示前20个差异，总共31个)
...
00000090: 06 2f c8 03 16 00 00 16 14 12 02 17 15 1b 0e 1b |./..............|
000000a0: 0a 11 01 17 15 1b 0e 1b 0a 11 01 00 0a 05 00 00 |................|
000000b0: 00 80 00 0a 05 01 00 00 80 00                   |..........|
```
