...
**输入文件**: __tests__/compiler/fixtures/postfix-unary.ts
**生成时间**: 2025-12-06T16:46:30.688Z
...
- 偏移量 0x4e: TS=0x03 vs WASM=0x04
- 偏移量 0x9c: TS=0x1a vs WASM=0x1e
- 偏移量 0xa5: TS=0x25 vs WASM=0x11
- 偏移量 0xa6: TS=0x01 vs WASM=0x02
- 偏移量 0xa7: TS=0x17 vs WASM=0x16
- 偏移量 0xa8: TS=0x15 vs WASM=0x03
- 偏移量 0xa9: TS=0x1b vs WASM=0x17
- 偏移量 0xaa: TS=0x0e vs WASM=0x15
- 偏移量 0xac: TS=0x0a vs WASM=0x0e
- 偏移量 0xad: TS=0x25 vs WASM=0x1b
- 偏移量 0xae: TS=0x01 vs WASM=0x0a
- 偏移量 0xaf: TS=0x17 vs WASM=0x11
- 偏移量 0xb0: TS=0x15 vs WASM=0x02
- 偏移量 0xb1: TS=0x1b vs WASM=0x16
- 偏移量 0xb2: TS=0x0e vs WASM=0x03
- 偏移量 0xb3: TS=0x1b vs WASM=0x17
- 偏移量 0xb4: TS=0x0a vs WASM=0x15
- 偏移量 0xb5: TS=0x11 vs WASM=0x1b
- 偏移量 0xb6: TS=0x01 vs WASM=0x0e
- 偏移量 0xb7: TS=0x00 vs WASM=0x1b
- ... (显示前20个差异，总共24个)
...
00000040: 00 00 00 00 00 0c 20 06 01 a4 01 00 00 00 03 01 |...... .........|
...
00000090: 00 68 00 00 24 01 00 0e 06 2f c8 03 1a 00 00 21 |.h..$..../.....!|
000000a0: 00 1b 0e 1b 0a 25 01 17 15 1b 0e 1b 0a 25 01 17 |.....%.......%..|
000000b0: 15 1b 0e 1b 0a 11 01 00                         |........|
```
