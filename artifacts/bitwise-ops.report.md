...
**输入文件**: __tests__/compiler/fixtures/bitwise-ops.ts
**生成时间**: 2025-12-02T17:07:51.163Z

## 大小对比

- TypeScript编译器: 587 字节
- WASM编译器: 545 字节
- 差异: 42 字节 (7.71%)
...
- 偏移量 0xae: TS=0x00 vs WASM=0x01
- 偏移量 0xb1: TS=0x00 vs WASM=0xca
- 偏移量 0xb2: TS=0x0c vs WASM=0x03
- 偏移量 0xb3: TS=0x20 vs WASM=0x00
- 偏移量 0xb4: TS=0x06 vs WASM=0x00
- 偏移量 0xb5: TS=0x01 vs WASM=0x00
- 偏移量 0xb6: TS=0xa4 vs WASM=0x0c
- 偏移量 0xb7: TS=0x01 vs WASM=0x20
- 偏移量 0xb8: TS=0x00 vs WASM=0x06
- 偏移量 0xb9: TS=0x00 vs WASM=0x01
- 偏移量 0xba: TS=0x00 vs WASM=0xa4
- 偏移量 0xbc: TS=0x01 vs WASM=0x00
- 偏移量 0xbd: TS=0x01 vs WASM=0x00
- 偏移量 0xbe: TS=0x09 vs WASM=0x00
- 偏移量 0xbf: TS=0x00 vs WASM=0x01
- 偏移量 0xc0: TS=0xca vs WASM=0x01
- 偏移量 0xc1: TS=0x03 vs WASM=0x01
- 偏移量 0xc2: TS=0xff vs WASM=0x09
- 偏移量 0xc3: TS=0xff vs WASM=0x00
- 偏移量 0xc4: TS=0xff vs WASM=0xca
- ... (显示前20个差异，总共313个)
...
000000a0: 65 08 62 61 73 65 06 6b 65 79 0d c8 03 00 00 00 |e.base.key......|
000000b0: 00 00 0c 20 06 01 a4 01 00 00 00 01 01 01 09 00 |... ............|
000000c0: ca 03 ff ff ff ff 0f 00 08 ec 05 c2 00 e3 29 06 |..............).|
000000d0: 2f c8 03 02 00 00 00 0c 43 06 01 ca 03 04 0b 04 |/.......C.......|
000000e0: 02 00 00 b0 01 0f 84 01 00 01 00 cc 03 00 01 00 |................|
000000f0: ce 03 00 01 00 d0 03 00 01 00 d2 03 00 00 30 d4 |..............0.|
00000100: 03 00 01 30 d6 03 00 02 30 d8 03 00 03 30 da 03 |...0....0....0..|
00000110: 00 04 30 dc 03 00 05 30 de 03 00 06 30 e0 03 00 |..0....0....0...|
00000120: 07 30 e2 03 00 08 30 e4 03 00 09 30 e6 01 00 00 |.0....0....0....|
00000130: 00 0c 03 5b 0a 00 63 09 00 63 08 00 63 07 00 63 |...[..c..c..c..c|
00000140: 06 00 63 05 00 63 04 00 63 03 00 63 02 00 63 01 |..c..c..c..c..c.|
00000150: 00 63 00 00 63 09 00 63 08 00 63 07 00 63 06 00 |.c..c..c..c..c..|
00000160: 63 05 00 63 04 00 63 03 00 63 02 00 63 01 00 63 |c..c..c..c..c..c|
00000170: 00 00 d3 b9 a2 cb d3 b8 a3 cc d3 b8 a4 cd d3 ba |................|
00000180: a1 ce d3 d4 af c5 04 d3 d4 b1 c5 05 d3 d4 b0 c5 |................|
00000190: 06 04 f3 00 00 00 d5 aa c5 07 d5 d6 a9 c5 08 64 |...............d|
000001a0: 00 00 64 01 00 9f 64 02 00 9f 64 03 00 9f 64 04 |..d...d...d...d.|
000001b0: 00 9f 64 05 00 9f 64 06 00 9f c5 09 64 07 00 ec |..d...d.....d...|
000001c0: 12 64 08 00 ec 07 64 09 00 b9 9f 28 64 09 00 b8 |.d....d....(d...|
000001d0: 9f 28 64 08 00 ec 07 64 09 00 b8 9f 28 64 09 00 |.(d....d....(d..|
000001e0: 28 c8 03 66 00 00 00 3c 02 28 0c 0c 0d 09 0c 0c |(..f...<.(......|
000001f0: 0d 05 0c 0c 0d 1b 0c 0c 0d 01 07 10 07 03 12 0d |................|
00000200: 07 10 07 03 12 09 07 10 07 03 2b 01 07 05 12 03 |..........+.....|
00000210: 07 1e 07 15 14 29 12 00 10 14 09 13 10 16 09 15 |.....)..........|
00000220: 10 1c 09 1b 10 0c 09 0b 10 16 09 15 10 14 14 0f |................|
00000230: 1c 04 1c 0a 16 0a 07 17 09 0a 16 0a 07 17 0a 04 |................|
00000240: 1c 0a 16 0a 07 17 0a 0a 11 0d 00                |...........|
```
