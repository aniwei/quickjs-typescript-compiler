...
- 偏移量 0xcc: TS=0x3b vs WASM=0x3d
- 偏移量 0xe8: TS=0x0c vs WASM=0x0e
- 偏移量 0xf1: TS=0x65 vs WASM=0x11
- 偏移量 0xf2: TS=0x00 vs WASM=0x65
- 偏移量 0xf4: TS=0x83 vs WASM=0x00
- 偏移量 0xf5: TS=0x8d vs WASM=0x0e
- 偏移量 0xf6: TS=0x85 vs WASM=0x83
- 偏移量 0xf7: TS=0xec vs WASM=0x8d
- 偏移量 0xf8: TS=0xf1 vs WASM=0x85
- 偏移量 0xf9: TS=0x0e vs WASM=0xec
- 偏移量 0xfa: TS=0x86 vs WASM=0xef
- 偏移量 0xfb: TS=0x39 vs WASM=0x0e
- 偏移量 0xfc: TS=0xe9 vs WASM=0x86
- 偏移量 0xfd: TS=0x00 vs WASM=0x39
- 偏移量 0xfe: TS=0x00 vs WASM=0xe9
- 偏移量 0x100: TS=0x43 vs WASM=0x00
- 偏移量 0x101: TS=0xea vs WASM=0x00
- 偏移量 0x102: TS=0x00 vs WASM=0x43
- 偏移量 0x103: TS=0x00 vs WASM=0xea
- 偏移量 0x105: TS=0x04 vs WASM=0x00
- ... (显示前20个差异，总共56个)
...
000000c0: 0c 62 06 00 ca 03 00 02 00 05 00 00 3b 02 ce 03 |.b..........;...|
000000d0: 01 00 20 d0 03 02 01 30 63 00 00 b7 cb 63 01 00 |.. ....0c....c..|
000000e0: 39 e4 00 00 00 f0 80 ee 0c cc 64 00 00 64 01 00 |9.........d..d..|
000000f0: 9f 65 00 00 83 8d 85 ec f1 0e 86 39 e9 00 00 00 |.e.........9....|
00000100: 43 ea 00 00 00 04 e7 00 00 00 64 00 00 24 02 00 |C.........d..$..|
00000110: 0e 06 2f cc 03 14 05 00 2c 34 1b 0e 1c 31 11 0e |../.....,4...1..|
00000120: 11 05 3b 0f 1b 0e 34 18 11 0f 00                |..;...4....|
```
