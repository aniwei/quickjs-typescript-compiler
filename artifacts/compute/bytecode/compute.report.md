...
- 偏移量 0x7f: TS=EOF vs WASM=0x03
- 偏移量 0x80: TS=EOF vs WASM=0x12
- 偏移量 0x81: TS=EOF vs WASM=0x07
- 偏移量 0x82: TS=EOF vs WASM=0x08
- 偏移量 0x83: TS=EOF vs WASM=0x07
- 偏移量 0x84: TS=EOF vs WASM=0x03
- 偏移量 0x85: TS=EOF vs WASM=0x07
- 偏移量 0x86: TS=EOF vs WASM=0x11
- 偏移量 0x87: TS=EOF vs WASM=0x00
...
00000070: 00 ce 03 00 01 00 d3 d4 9f 28 c8 03 00 00       |.........(....|
```
