...
- 偏移量 0xf7: TS=0x18 vs WASM=0x1e
- 偏移量 0xfa: TS=0xc6 vs WASM=0x00
- 偏移量 0xfb: TS=0x16 vs WASM=0x43
- 偏移量 0xfc: TS=0x00 vs WASM=0x14
- 偏移量 0xfd: TS=0x1c vs WASM=0x00
- 偏移量 0xfe: TS=0x12 vs WASM=0x1b
- 偏移量 0xff: TS=0x15 vs WASM=0x0e
- 偏移量 0x100: TS=0x34 vs WASM=0x1b
- 偏移量 0x101: TS=0x18 vs WASM=0x0a
- 偏移量 0x105: TS=0x07 vs WASM=0x0c
- 偏移量 0x107: TS=0x1a vs WASM=0x06
- 偏移量 0x108: TS=0x30 vs WASM=0x1b
- 偏移量 0x109: TS=0x31 vs WASM=0x1b
- 偏移量 0x10a: TS=0x34 vs WASM=0x17
- 偏移量 0x10b: TS=0x18 vs WASM=0x15
- 偏移量 0x10c: TS=0x11 vs WASM=0x1b
- 偏移量 0x10d: TS=0x08 vs WASM=0x0e
- 偏移量 0x110: TS=0x00 vs WASM=0x11
- 偏移量 0x111: TS=EOF vs WASM=0x08
- 偏移量 0x112: TS=EOF vs WASM=0x1b
- ... (显示前20个差异，总共24个)
...
000000f0: 01 00 0e 06 2f c8 03 18 00 00 c6 16 00 1c 12 15 |..../...........|
00000100: 34 18 11 08 20 07 07 1a 30 31 34 18 11 08 1b 0a |4... ...014.....|
00000110: 00                                              |.|
```
