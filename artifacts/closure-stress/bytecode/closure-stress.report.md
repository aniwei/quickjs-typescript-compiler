...
**生成时间**: 2025-12-20T21:36:56.988Z

## 大小对比

- TypeScript编译器: 396 字节
- WASM编译器: 446 字节
- 差异: -50 字节 (-11.21%)
...
- 偏移量 0x104: TS=0x00 vs WASM=0x08
- 偏移量 0x106: TS=0x0c vs WASM=0x00
- 偏移量 0x107: TS=0x43 vs WASM=0x00
- 偏移量 0x108: TS=0x06 vs WASM=0x32
- 偏移量 0x109: TS=0x00 vs WASM=0x32
- 偏移量 0x10a: TS=0xe0 vs WASM=0x08
- 偏移量 0x10b: TS=0x03 vs WASM=0x0c
- 偏移量 0x10c: TS=0x00 vs WASM=0x0a
- 偏移量 0x10e: TS=0x00 vs WASM=0x0c
- 偏移量 0x10f: TS=0x02 vs WASM=0x43
- 偏移量 0x110: TS=0x0a vs WASM=0x06
- 偏移量 0x112: TS=0x4c vs WASM=0xe0
- 偏移量 0x113: TS=0x00 vs WASM=0x03
- 偏移量 0x114: TS=0xcc vs WASM=0x00
- 偏移量 0x115: TS=0x03 vs WASM=0x00
- 偏移量 0x117: TS=0x09 vs WASM=0x02
- 偏移量 0x118: TS=0xce vs WASM=0x0a
- 偏移量 0x119: TS=0x03 vs WASM=0x00
- 偏移量 0x11a: TS=0x01 vs WASM=0x4c
- 偏移量 0x11b: TS=0x09 vs WASM=0x00
- ... (显示前20个差异，总共141个)
...
00000100: f0 29 ca 03 00 00 0c 43 06 00 e0 03 00 00 00 02 |.).....C........|
00000110: 0a 00 4c 00 cc 03 00 09 ce 03 01 09 d0 03 02 09 |..L.............|
00000120: d2 03 03 09 d4 03 04 09 d6 03 05 01 d8 03 06 01 |................|
00000130: da 03 07 01 dc 03 08 01 de 03 09 01 68 00 00 93 |............h...|
00000140: 69 00 00 0e 68 01 00 93 69 01 00 0e 68 02 00 93 |i...h...i...h...|
00000150: 69 02 00 0e 68 03 00 93 69 03 00 0e 68 04 00 93 |i...h...i...h...|
00000160: 69 04 00 0e 60 05 00 91 61 05 00 60 06 00 91 61 |i...`...a..`...a|
00000170: 06 00 60 07 00 91 61 07 00 60 08 00 91 61 08 00 |..`...a..`...a..|
00000180: 60 09 00 91 61 09 00 29 ca 03 00 00             |`...a..)....|
```
