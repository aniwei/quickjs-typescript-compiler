...
- 偏移量 0xa6: TS=0x0a vs WASM=0x16
- 偏移量 0xad: TS=0x4f vs WASM=0x1b
- 偏移量 0xae: TS=0x00 vs WASM=0x0e
- 偏移量 0xaf: TS=0x72 vs WASM=0x20
- 偏移量 0xb0: TS=0x00 vs WASM=0x08
- 偏移量 0xb1: TS=0x00 vs WASM=0x18
- 偏移量 0xb2: TS=EOF vs WASM=0x15
- 偏移量 0xb3: TS=EOF vs WASM=0x1b
- 偏移量 0xb4: TS=EOF vs WASM=0x0e
- 偏移量 0xb5: TS=EOF vs WASM=0x20
- 偏移量 0xb6: TS=EOF vs WASM=0x08
- 偏移量 0xb7: TS=EOF vs WASM=0x3b
- 偏移量 0xb8: TS=EOF vs WASM=0x15
- 偏移量 0xb9: TS=EOF vs WASM=0x1b
- 偏移量 0xba: TS=EOF vs WASM=0x0e
- 偏移量 0xbb: TS=EOF vs WASM=0x20
- 偏移量 0xbc: TS=EOF vs WASM=0x08
- 偏移量 0xbd: TS=EOF vs WASM=0x00
...
000000a0: 0e 0e 06 2f c8 03 0a 00 00 21 10 2c 00 4f 00 72 |.../.....!.,.O.r|
000000b0: 00 00                                           |..|
```
