...
- 偏移量 0xb5: TS=0xc7 vs WASM=0x44
- 偏移量 0xb6: TS=0xd4 vs WASM=0xe7
- 偏移量 0xb7: TS=0x15 vs WASM=0x00
- 偏移量 0xb8: TS=0x44 vs WASM=0x00
- 偏移量 0xb9: TS=0xe7 vs WASM=0x00
- 偏移量 0xba: TS=0x00 vs WASM=0x29
- 偏移量 0xbb: TS=0x00 vs WASM=0xc8
- 偏移量 0xbc: TS=0x00 vs WASM=0x03
- 偏移量 0xbd: TS=0x0e vs WASM=0x0a
- 偏移量 0xbe: TS=0x29 vs WASM=0x01
- 偏移量 0xbf: TS=0xc8 vs WASM=0x04
- 偏移量 0xc0: TS=0x03 vs WASM=0x4e
- ... (显示前20个差异，总共30个)
...
000000a0: 68 00 00 11 ec 06 c7 1b 24 00 00 0e c7 d3 15 44 |h.......$......D|
000000b0: e6 00 00 00 0e c7 d4 15 44 e7 00 00 00 0e 29 c8 |........D.....).|
000000c0: 03 0a 01 04 4e 08 07 12 2b 11 07 12 00          |....N...+....|
```
