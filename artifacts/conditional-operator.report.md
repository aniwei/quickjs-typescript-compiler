...
**输入文件**: __tests__/fixtures/conditional-operator.ts
**生成时间**: 2025-12-16T06:50:03.525Z
...
- 偏移量 0x77: TS=0x4d vs WASM=0x1b
- 偏移量 0x78: TS=0x18 vs WASM=0x0e
- 偏移量 0x79: TS=0x7f vs WASM=0x1b
- 偏移量 0x7a: TS=0x1a vs WASM=0x0a
- 偏移量 0x7b: TS=0x4d vs WASM=0x1b
- 偏移量 0x7d: TS=0x34 vs WASM=0x1b
...
00000070: cf 28 ce 03 0a 00 00 4d 18 7f 1a 4d 08 34 39 00 |.(.....M...M.49.|
```
