...
- 偏移量 0x9e: TS=0x00 vs WASM=0x01
- 偏移量 0xa6: TS=0x00 vs WASM=0x0a
- 偏移量 0xa8: TS=EOF vs WASM=0x0c
- 偏移量 0xa9: TS=EOF vs WASM=0x03
- 偏移量 0xaa: TS=EOF vs WASM=0x01
- 偏移量 0xab: TS=EOF vs WASM=0x07
- 偏移量 0xac: TS=EOF vs WASM=0x08
- 偏移量 0xad: TS=EOF vs WASM=0x07
- 偏移量 0xae: TS=EOF vs WASM=0x03
- 偏移量 0xaf: TS=EOF vs WASM=0x07
- 偏移量 0xb0: TS=EOF vs WASM=0x11
- 偏移量 0xb1: TS=EOF vs WASM=0x00
...
00000050: 3f 6a 00 00 00 80 c2 00 4f 00 00 00 00 3b 6a 00 |?j......O....;j.|
...
00000090: 02 02 00 00 04 02 ce 03 00 00 00 d0 03 00 00 00 |................|
000000a0: d3 d4 9f 28 cc 03 00 00                         |...(....|
```
