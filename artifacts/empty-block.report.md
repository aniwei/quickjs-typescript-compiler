...
**输入文件**: __tests__/compiler/fixtures/empty-block.ts
**生成时间**: 2025-12-02T17:07:51.224Z

## 大小对比

- TypeScript编译器: 123 字节
- WASM编译器: 122 字节
- 差异: 1 字节 (0.82%)
...
- 偏移量 0x66: TS=0xc7 vs WASM=0x24
- 偏移量 0x67: TS=0x24 vs WASM=0x01
- ... (显示前20个差异，总共38个)
...
00000040: 00 00 00 0c 20 06 01 a4 01 00 01 00 03 00 00 17 |.... ...........|
00000050: 01 ca 03 02 00 20 08 ec 02 29 b8 cb 39 e6 00 00 |..... ...)..9...|
00000060: 00 43 e7 00 00 00 c7 24 01 00 0e 06 2f c8 03 0a |.C.....$..../...|
00000070: 00 00 23 04 1b 0e 1b 0a 07 01 00                |..#........|
```
