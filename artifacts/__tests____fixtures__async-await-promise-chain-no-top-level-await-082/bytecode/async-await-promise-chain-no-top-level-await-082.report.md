...
**输入文件**: /Users/aniwei/Desktop/workspaces/quickjs-typescript-compiler/__tests__/fixtures/async-await-promise-chain-no-top-level-await-082.ts
**生成时间**: 2026-01-07T07:07:35.474Z
...
```json
{
  ...
  "atoms": [
    ...
    },
    {
      ...
      "actualLength": 70,
      "isWideChar": 0,
      "string": "__tests__/fixtures/async-await-promise-chain-no-top-level-await-082.js",
      "offset": 8
    },
    {
      "index": 2,
...
### TypeScript
```
00000000: 05 08 0a 72 75 6e 38 32 8c 01 5f 5f 74 65 73 74 |...run82..__test|
...
00000040: 76 65 6c 2d 61 77 61 69 74 2d 30 38 32 2e 6a 73 |vel-await-082.js|
...
000000d0: 00 00 43 82 00 00 00 bf 52 24 01 00 cb 64 00 00 |..C.....R$...d..|
