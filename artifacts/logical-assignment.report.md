...
**输入文件**: __tests__/fixtures/logical-assignment.ts
**生成时间**: 2025-12-19T19:00:55.665Z

## 大小对比

- TypeScript编译器: 493 字节
- WASM编译器: 513 字节
- 差异: -20 字节 (-3.90%)
...
- 偏移量 0x1c7: TS=0x24 vs WASM=0x38
- 偏移量 0x1cb: TS=0x43 vs WASM=0x54
- 偏移量 0x1cc: TS=0x02 vs WASM=0x08
- 偏移量 0x1ce: TS=0x21 vs WASM=0x5d
- 偏移量 0x1d0: TS=0x3b vs WASM=0x71
- 偏移量 0x1d2: TS=0x5d vs WASM=0x76
- 偏移量 0x1d4: TS=0x34 vs WASM=0x62
- 偏移量 0x1d5: TS=0x0c vs WASM=0x00
- 偏移量 0x1d6: TS=0x3f vs WASM=0x1b
- 偏移量 0x1d7: TS=0x0b vs WASM=0x0e
- 偏移量 0x1d8: TS=0x39 vs WASM=0x1b
- 偏移量 0x1d9: TS=0x0c vs WASM=0x0a
- 偏移量 0x1da: TS=0x3f vs WASM=0x1b
- 偏移量 0x1db: TS=0x0b vs WASM=0x06
- 偏移量 0x1dc: TS=0x62 vs WASM=0x1b
- 偏移量 0x1dd: TS=0x00 vs WASM=0x06
- 偏移量 0x1df: TS=0x0e vs WASM=0x06
- 偏移量 0x1e1: TS=0x0a vs WASM=0x13
- 偏移量 0x1e2: TS=0x1b vs WASM=0x90
- 偏移量 0x1e3: TS=0x06 vs WASM=0x15
- ... (显示前20个差异，总共46个)
...
000001c0: 24 03 00 cf 28 e0 03 24 00 00 00 43 02 00 21 00 |$...(..$...C..!.|
000001d0: 3b 00 5d 00 34 0c 3f 0b 39 0c 3f 0b 62 00 1b 0e |;.].4.?.9.?.b...|
000001e0: 1b 0a 1b 06 1b 06 1b 06 1b 13 76 15 00          |..........v..|
```
