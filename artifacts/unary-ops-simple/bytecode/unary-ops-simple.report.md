...
- 偏移量 0xba: TS=0x00 vs WASM=0x2a
- 偏移量 0xbb: TS=0x14 vs WASM=0x00
- 偏移量 0xbc: TS=0x48 vs WASM=0x00
- 偏移量 0xbd: TS=0x0c vs WASM=0x2f
- 偏移量 0xbe: TS=0x1c vs WASM=0x0e
- 偏移量 0xbf: TS=0x74 vs WASM=0x1b
- 偏移量 0xc0: TS=0x34 vs WASM=0x0a
- 偏移量 0xc1: TS=0x0d vs WASM=0x07
- 偏移量 0xc2: TS=0x21 vs WASM=0x01
- 偏移量 0xc3: TS=0x73 vs WASM=0x17
- 偏移量 0xc4: TS=0x34 vs WASM=0x15
- 偏移量 0xc5: TS=0x0d vs WASM=0x1b
- 偏移量 0xc6: TS=0x21 vs WASM=0x0e
- 偏移量 0xc7: TS=0x73 vs WASM=0x20
- 偏移量 0xc8: TS=0x34 vs WASM=0x0a
- 偏移量 0xc9: TS=0x0d vs WASM=0x07
- 偏移量 0xca: TS=0x21 vs WASM=0x01
- 偏移量 0xcb: TS=0x73 vs WASM=0x17
- 偏移量 0xcc: TS=0x34 vs WASM=0x15
- 偏移量 0xcd: TS=0x13 vs WASM=0x1b
- ... (显示前20个差异，总共44个)
...
000000b0: 00 06 24 01 00 0e 06 2f c8 03 00 14 48 0c 1c 74 |..$..../....H..t|
000000c0: 34 0d 21 73 34 0d 21 73 34 0d 21 73 34 13 21 6d |4.!s4.!s4.!s4.!m|
000000d0: 00                                              |.|
```
