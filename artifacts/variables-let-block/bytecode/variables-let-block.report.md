...
- 偏移量 0x59: TS=0x00 vs WASM=0x80
- 偏移量 0x5f: TS=0x12 vs WASM=0x82
- 偏移量 0x7b: TS=0x0e vs WASM=0xcb
- 偏移量 0x92: TS=0x16 vs WASM=0x12
- 偏移量 0x95: TS=0x3e vs WASM=0x78
- 偏移量 0x96: TS=0x10 vs WASM=0x08
- 偏移量 0x97: TS=0x07 vs WASM=0x1b
- 偏移量 0x98: TS=0x07 vs WASM=0x0e
- 偏移量 0x99: TS=0x2c vs WASM=0x1b
- 偏移量 0x9a: TS=0x10 vs WASM=0x0a
- 偏移量 0x9b: TS=0x07 vs WASM=0x11
- 偏移量 0x9c: TS=0x07 vs WASM=0x01
- 偏移量 0x9d: TS=0x08 vs WASM=0x18
- 偏移量 0x9e: TS=0x07 vs WASM=0x1d
- 偏移量 0x9f: TS=0x34 vs WASM=0x1b
- 偏移量 0xa0: TS=0x18 vs WASM=0x0e
- 偏移量 0xa1: TS=0x11 vs WASM=0x1b
- 偏移量 0xa2: TS=0x17 vs WASM=0x0a
- 偏移量 0xa3: TS=0x18 vs WASM=0x1b
- 偏移量 0xa4: TS=0x07 vs WASM=0x01
- ... (显示前20个差异，总共25个)
...
00000050: 03 02 00 20 40 e5 00 00 00 00 3f e5 00 00 00 12 |... @.....?.....|
00000060: b8 3b e5 00 00 00 63 01 00 b9 cc 39 e6 00 00 00 |.;....c....9....|
00000070: 43 e7 00 00 00 64 01 00 24 01 00 0e 39 e6 00 00 |C....d..$...9...|
00000080: 00 43 e7 00 00 00 39 e5 00 00 00 24 01 00 cf 28 |.C....9....$...(|
00000090: d0 03 16 00 00 3e 10 07 07 2c 10 07 07 08 07 34 |.....>...,.....4|
000000a0: 18 11 17 18 07 34 18 1b 17 00                   |.....4....|
```
