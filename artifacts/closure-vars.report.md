...
- 偏移量 0xd8: TS=0x53 vs WASM=0x55
- 偏移量 0x136: TS=0x69 vs WASM=0x11
- 偏移量 0x137: TS=0x01 vs WASM=0x69
- 偏移量 0x138: TS=0x00 vs WASM=0x01
- 偏移量 0x139: TS=0xbf vs WASM=0x00
- 偏移量 0x13a: TS=0x14 vs WASM=0x0e
- 偏移量 0x13b: TS=0xe6 vs WASM=0xbf
- 偏移量 0x13c: TS=0x29 vs WASM=0x14
- 偏移量 0x13d: TS=0xca vs WASM=0xe6
- 偏移量 0x13e: TS=0x03 vs WASM=0x29
- 偏移量 0x13f: TS=0x2a vs WASM=0xca
- 偏移量 0x140: TS=0x05 vs WASM=0x03
- 偏移量 0x141: TS=0x04 vs WASM=0x2a
- 偏移量 0x142: TS=0x03 vs WASM=0x05
- 偏移量 0x143: TS=0x08 vs WASM=0x04
- 偏移量 0x144: TS=0x1b vs WASM=0x03
- 偏移量 0x145: TS=0x0e vs WASM=0x08
- 偏移量 0x147: TS=0x0a vs WASM=0x0e
- 偏移量 0x148: TS=0x11 vs WASM=0x1b
- 偏移量 0x149: TS=0x01 vs WASM=0x0a
- ... (显示前20个差异，总共51个)
...
000000d0: d4 03 00 00 00 03 04 00 53 00 cc 03 00 09 ce 03 |........S.......|
...
00000130: 69 00 00 0e bf 0a 69 01 00 bf 14 e6 29 ca 03 2a |i.....i.....)..*|
00000140: 05 04 03 08 1b 0e 1b 0a 11 01 17 15 1b 0e 1b 0a |................|
00000150: 11 01 17 15 1b 0e 1b 0a 11 01 17 15 1b 0e 1b 0a |................|
00000160: 07 01 17 15 11 02 1c 01 1c 00 00                |...........|
```
