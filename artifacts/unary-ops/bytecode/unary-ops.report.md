...
- 偏移量 0xb3: TS=0x12 vs WASM=0x2a
- 偏移量 0xb6: TS=0x67 vs WASM=0x2f
- 偏移量 0xb7: TS=0x00 vs WASM=0x0e
- 偏移量 0xb8: TS=0x39 vs WASM=0x25
- 偏移量 0xb9: TS=0x18 vs WASM=0x08
- 偏移量 0xba: TS=0x1c vs WASM=0x17
- 偏移量 0xbb: TS=0x17 vs WASM=0x15
- 偏移量 0xbc: TS=0x39 vs WASM=0x1b
- 偏移量 0xbd: TS=0x18 vs WASM=0x0e
- 偏移量 0xbe: TS=0x1c vs WASM=0x20
- 偏移量 0xbf: TS=0x17 vs WASM=0x0a
- 偏移量 0xc0: TS=0x34 vs WASM=0x07
- 偏移量 0xc1: TS=0x18 vs WASM=0x01
- 偏移量 0xc2: TS=0x1c vs WASM=0x17
- 偏移量 0xc3: TS=0x17 vs WASM=0x15
- 偏移量 0xc4: TS=0x53 vs WASM=0x1b
- 偏移量 0xc5: TS=0x00 vs WASM=0x0e
- 偏移量 0xc6: TS=0x00 vs WASM=0x20
- 偏移量 0xc7: TS=EOF vs WASM=0x0a
- 偏移量 0xc8: TS=EOF vs WASM=0x07
- ... (显示前20个差异，总共42个)
...
000000b0: 2f c8 03 12 00 00 67 00 39 18 1c 17 39 18 1c 17 |/.....g.9...9...|
000000c0: 34 18 1c 17 53 00 00                            |4...S..|
```
