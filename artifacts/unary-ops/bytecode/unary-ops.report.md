...
- 偏移量 0x60: TS=0x03 vs WASM=0x07
- 偏移量 0x63: TS=0x35 vs WASM=0x31
- 偏移量 0x81: TS=0x01 vs WASM=0xbf
- 偏移量 0x83: TS=0x00 vs WASM=0xe7
- 偏移量 0x84: TS=0x00 vs WASM=0x8e
- 偏移量 0x85: TS=0x00 vs WASM=0xe4
- 偏移量 0x86: TS=0xe3 vs WASM=0xdf
- 偏移量 0x87: TS=0xdf vs WASM=0x98
- 偏移量 0x88: TS=0x8e vs WASM=0xe5
- 偏移量 0x89: TS=0xe4 vs WASM=0xdf
- 偏移量 0x8a: TS=0xdf vs WASM=0x97
- 偏移量 0x8b: TS=0x98 vs WASM=0xe6
- 偏移量 0x8c: TS=0xe5 vs WASM=0x06
- 偏移量 0x8d: TS=0xdf vs WASM=0x61
- 偏移量 0x8e: TS=0x97 vs WASM=0x04
- 偏移量 0x8f: TS=0xe6 vs WASM=0x00
- 偏移量 0x90: TS=0x06 vs WASM=0xdf
- 偏移量 0x91: TS=0x61 vs WASM=0x99
- 偏移量 0x92: TS=0x04 vs WASM=0x61
- 偏移量 0x93: TS=0x00 vs WASM=0x05
- ... (显示前20个差异，总共77个)
...
00000060: 03 06 00 35 00 ca 03 00 01 cc 03 01 01 ce 03 02 |...5............|
00000070: 01 d0 03 03 01 d2 03 04 01 d4 03 05 01 08 ec 02 |................|
00000080: 29 01 0a 00 00 00 e3 df 8e e4 df 98 e5 df 97 e6 |)...............|
00000090: 06 61 04 00 df 99 61 05 00 39 eb 00 00 00 43 ec |.a....a..9....C.|
000000a0: 00 00 00 e0 e1 e2 60 04 00 60 05 00 24 05 00 0e |......`..`..$...|
000000b0: 06 2f c8 03 00 16 16 0a 21 01 12 00 12 00 12 7f |./......!.......|
000000c0: 17 07 1c 6f 34 0c 07 05 07 05 07 05 00          |...o4........|
```
