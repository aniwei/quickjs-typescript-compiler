...
- 偏移量 0x61: TS=0x01 vs WASM=0x80
- 偏移量 0x67: TS=0x01 vs WASM=0x80
- 偏移量 0x6d: TS=0x10 vs WASM=0x80
- 偏移量 0x73: TS=0x10 vs WASM=0x80
- 偏移量 0x77: TS=0x00 vs WASM=0x6a
- 偏移量 0xb7: TS=0x22 vs WASM=0x18
- 偏移量 0xba: TS=0x7a vs WASM=0xb9
- 偏移量 0xbb: TS=0x18 vs WASM=0x00
- 偏移量 0xbc: TS=0x25 vs WASM=0x1b
- 偏移量 0xbd: TS=0x0b vs WASM=0x0e
- 偏移量 0xbe: TS=0x1e vs WASM=0x1b
- 偏移量 0xbf: TS=0x0b vs WASM=0x0a
- 偏移量 0xc0: TS=0x34 vs WASM=0x25
- 偏移量 0xc1: TS=0x18 vs WASM=0x06
- 偏移量 0xc2: TS=0x1b vs WASM=0x07
- 偏移量 0xc3: TS=0x08 vs WASM=0x07
- 偏移量 0xc4: TS=0x07 vs WASM=0x00
- 偏移量 0xc5: TS=0x06 vs WASM=0x0b
- 偏移量 0xc6: TS=0x07 vs WASM=0x08
- 偏移量 0xc7: TS=0x0d vs WASM=0x15
- ... (显示前20个差异，总共161个)
...
00000060: 00 01 40 e4 00 00 00 01 3f 6a 00 00 00 10 3f e4 |..@.....?j....?.|
00000070: 00 00 00 10 c2 00 4f 00 00 00 00 3b 6a 00 00 00 |......O....;j...|
...
000000b0: 24 01 00 cf 28 ce 03 22 00 00 7a 18 25 0b 1e 0b |$...(.."..z.%...|
000000c0: 34 18 1b 08 07 06 07 0d 07 17 17 18 0c 0b 1e 0b |4...............|
000000d0: 34 18 1b 08 0c 08 07 0f 07 17 00 0c 43 06 00 00 |4...........C...|
000000e0: 02 00 02 00 00 00 28 02 d0 03 00 00 00 d2 03 00 |......(.........|
000000f0: 00 00 b6 01 00 c8 29 00 00 00 ba e5 00 00 00 01 |......).........|
00000100: 00 c8 2d 00 00 00 ba e6 00 00 00 01 00 c8 2b 00 |..-...........+.|
00000110: 00 00 9f c8 22 00 00 00 28 29 ce 03 00 00 0c 43 |...."...().....C|
00000120: 06 00 d4 03 02 00 02 00 00 00 28 02 d0 03 00 00 |..........(.....|
00000130: 00 d2 03 00 00 00 b6 01 00 c8 7b 00 00 00 ba e5 |..........{.....|
00000140: 00 00 00 01 00 c8 7f 00 00 00 ba e6 00 00 00 01 |................|
00000150: 00 c8 7d 00 00 00 a0 c8 74 00 00 00 28 29 ce 03 |..}.....t...()..|
00000160: 00 00                                           |..|
```
