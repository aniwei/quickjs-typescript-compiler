...
- 偏移量 0x7b: TS=0x0c vs WASM=0x0a
- 偏移量 0x82: TS=0x30 vs WASM=0x45
- 偏移量 0x83: TS=0x04 vs WASM=0x05
- 偏移量 0x84: TS=0x17 vs WASM=0x16
- 偏移量 0x85: TS=0x09 vs WASM=0x06
- 偏移量 0x86: TS=0x16 vs WASM=0x00
- 偏移量 0x87: TS=0x06 vs WASM=EOF
- 偏移量 0x88: TS=0x00 vs WASM=EOF
...
00000070: e4 68 01 00 b7 9a 0e 06 2f c8 03 0c 00 00 3f 0e |.h....../.....?.|
00000080: 11 06 30 04 17 09 16 06 00                      |..0......|
```
