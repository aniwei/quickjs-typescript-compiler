...
- 偏移量 0xa4: TS=0x00 vs WASM=0x01
- 偏移量 0xc6: TS=0x00 vs WASM=0x18
- 偏移量 0xc8: TS=EOF vs WASM=0x10
- 偏移量 0xc9: TS=EOF vs WASM=0x22
- 偏移量 0xca: TS=EOF vs WASM=0x0f
- 偏移量 0xcb: TS=EOF vs WASM=0x07
- 偏移量 0xcc: TS=EOF vs WASM=0x08
- 偏移量 0xcd: TS=EOF vs WASM=0x11
- 偏移量 0xce: TS=EOF vs WASM=0x03
- 偏移量 0xcf: TS=EOF vs WASM=0x12
- 偏移量 0xd0: TS=EOF vs WASM=0x0a
- 偏移量 0xd1: TS=EOF vs WASM=0x07
- 偏移量 0xd2: TS=EOF vs WASM=0x08
- 偏移量 0xd3: TS=EOF vs WASM=0x11
- 偏移量 0xd4: TS=EOF vs WASM=0x03
- 偏移量 0xd5: TS=EOF vs WASM=0x07
- 偏移量 0xd6: TS=EOF vs WASM=0x11
- 偏移量 0xd7: TS=EOF vs WASM=0x09
- 偏移量 0xd8: TS=EOF vs WASM=0x06
- ... (显示前20个差异，总共27个)
...
00000060: c2 00 4f 00 00 00 00 3b e4 00 00 00 39 e5 00 00 |..O....;....9...|
...
000000a0: 02 d0 03 00 00 00 d2 03 01 00 30 63 00 00 bf 0a |..........0c....|
000000b0: cb d3 64 00 00 a7 ec 07 d3 64 00 00 a0 28 64 00 |..d......d...(d.|
000000c0: 00 d3 a0 28 ce 03 00 00                         |...(....|
```
