...
- 偏移量 0xb7: TS=0x00 vs WASM=0x08
- 偏移量 0xb9: TS=0x0c vs WASM=0x00
- 偏移量 0xba: TS=0x43 vs WASM=0x00
- 偏移量 0xbb: TS=0x06 vs WASM=0x0f
- 偏移量 0xbc: TS=0x00 vs WASM=0x1a
- 偏移量 0xbd: TS=0xd6 vs WASM=0x08
- 偏移量 0xbe: TS=0x03 vs WASM=0x0c
- 偏移量 0xbf: TS=0x00 vs WASM=0x0a
- 偏移量 0xc1: TS=0x00 vs WASM=0x0c
- 偏移量 0xc2: TS=0x01 vs WASM=0x43
- 偏移量 0xc3: TS=0x05 vs WASM=0x06
- 偏移量 0xc5: TS=0x14 vs WASM=0xd6
- 偏移量 0xc6: TS=0x00 vs WASM=0x03
- 偏移量 0xc7: TS=0xcc vs WASM=0x00
- 偏移量 0xc8: TS=0x03 vs WASM=0x00
- 偏移量 0xcb: TS=0xce vs WASM=0x05
- 偏移量 0xcc: TS=0x03 vs WASM=0x00
- 偏移量 0xcd: TS=0x01 vs WASM=0x14
- 偏移量 0xce: TS=0x01 vs WASM=0x00
- 偏移量 0xcf: TS=0xd0 vs WASM=0xcc
- ... (显示前20个差异，总共77个)
...
000000b0: 04 c4 05 f0 29 ca 03 00 00 0c 43 06 00 d6 03 00 |....).....C.....|
000000c0: 00 00 01 05 00 14 00 cc 03 00 01 ce 03 01 01 d0 |................|
000000d0: 03 02 01 d2 03 03 01 d4 03 04 01 df 91 e3 e0 91 |................|
000000e0: e4 e1 91 e5 e2 91 e6 60 04 00 91 61 04 00 29 ca |.......`...a..).|
000000f0: 03 00 00                                        |...|
```
