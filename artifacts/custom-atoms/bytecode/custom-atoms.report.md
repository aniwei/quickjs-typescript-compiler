...
- 偏移量 0x71: TS=0x23 vs WASM=0x20
- 偏移量 0x85: TS=0x01 vs WASM=0xbf
- 偏移量 0x87: TS=0x00 vs WASM=0xe4
- 偏移量 0x88: TS=0x00 vs WASM=0x39
- 偏移量 0x89: TS=0x00 vs WASM=0xe8
- 偏移量 0x8a: TS=0xe4 vs WASM=0x00
- 偏移量 0x8b: TS=0x39 vs WASM=0x00
- 偏移量 0x8c: TS=0xe8 vs WASM=0x00
- 偏移量 0x8d: TS=0x00 vs WASM=0x43
- 偏移量 0x8e: TS=0x00 vs WASM=0xe9
- 偏移量 0x90: TS=0x43 vs WASM=0x00
- 偏移量 0x91: TS=0xe9 vs WASM=0x00
- 偏移量 0x92: TS=0x00 vs WASM=0x68
- 偏移量 0x95: TS=0x68 vs WASM=0x24
- 偏移量 0x96: TS=0x00 vs WASM=0x01
- 偏移量 0x98: TS=0x24 vs WASM=0x0e
- 偏移量 0x99: TS=0x01 vs WASM=0x06
- 偏移量 0x9a: TS=0x00 vs WASM=0x2f
- 偏移量 0x9b: TS=0x0e vs WASM=0xc8
- 偏移量 0x9c: TS=0x06 vs WASM=0x03
- ... (显示前20个差异，总共31个)
...
00000070: 00 23 00 ca 03 00 0d cc 03 01 0d 08 ec 02 29 04 |.#............).|
00000080: e7 00 00 00 e3 01 2a 00 00 00 e4 39 e8 00 00 00 |......*....9....|
00000090: 43 e9 00 00 00 68 00 00 24 01 00 0e 06 2f c8 03 |C....h..$..../..|
000000a0: 00 06 16 17 21 7f 21 6a 00                      |....!.!j.|
```
