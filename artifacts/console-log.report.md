...
- 偏移量 0x76: TS=0x0a vs WASM=0x06
- 偏移量 0x77: TS=0x03 vs WASM=0x00
- 偏移量 0x79: TS=0x15 vs WASM=0x2f
- 偏移量 0x7a: TS=0x00 vs WASM=0x0e
- 偏移量 0x7b: TS=0x1b vs WASM=0x34
- 偏移量 0x7c: TS=0x07 vs WASM=0x08
- 偏移量 0x7d: TS=0x34 vs WASM=0x00
- 偏移量 0x7e: TS=0x04 vs WASM=EOF
- 偏移量 0x7f: TS=0x17 vs WASM=EOF
- 偏移量 0x80: TS=0x75 vs WASM=EOF
- 偏移量 0x81: TS=0x00 vs WASM=EOF
...
00000070: 00 0e 06 2f c8 03 0a 03 00 15 00 1b 07 34 04 17 |.../.........4..|
00000080: 75 00                                           |u.|
```
