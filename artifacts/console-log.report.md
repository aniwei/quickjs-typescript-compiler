...
**输入文件**: __tests__/fixtures/console-log.ts
**生成时间**: 2025-12-16T13:04:50.618Z
...
- 偏移量 0x68: TS=0x34 vs WASM=0x1b
- 偏移量 0x69: TS=0x18 vs WASM=0x0e
- 偏移量 0x6a: TS=0x1b vs WASM=0x34
- 偏移量 0x6b: TS=0x17 vs WASM=0x08
...
00000060: 00 cf 28 ce 03 06 00 00 34 18 1b 17 00          |..(.....4....|
```
