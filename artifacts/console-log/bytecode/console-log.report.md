...
**生成时间**: 2025-12-09T14:28:02.686Z

## 大小对比

- TypeScript编译器: 122 字节
- WASM编译器: 126 字节
- 差异: -4 字节 (-3.17%)
...
- 偏移量 0x76: TS=0x02 vs WASM=0x06
- 偏移量 0x79: TS=0x00 vs WASM=0x2f
- 偏移量 0x7a: TS=EOF vs WASM=0x0e
- 偏移量 0x7b: TS=EOF vs WASM=0x34
- 偏移量 0x7c: TS=EOF vs WASM=0x08
- 偏移量 0x7d: TS=EOF vs WASM=0x00
...
00000070: 00 0e 06 2f c8 03 02 00 00 00                   |.../......|
```
