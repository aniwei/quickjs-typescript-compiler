...
**生成时间**: 2025-12-06T02:09:56.333Z

## 大小对比

- TypeScript编译器: 105 字节
- WASM编译器: 110 字节
- 差异: -5 字节 (-4.55%)
...
- 偏移量 0x66: TS=0x00 vs WASM=0x06
- 偏移量 0x69: TS=EOF vs WASM=0x2f
- 偏移量 0x6a: TS=EOF vs WASM=0x0e
- 偏移量 0x6b: TS=EOF vs WASM=0x20
- 偏移量 0x6c: TS=EOF vs WASM=0x08
...
00000060: 00 0e 06 2f c8 03 00 00 00                      |.../.....|
```
