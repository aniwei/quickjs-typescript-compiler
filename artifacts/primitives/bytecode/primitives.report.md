...
- 偏移量 0xb6: TS=0x24 vs WASM=0x26
- 偏移量 0xc1: TS=0x34 vs WASM=0x1b
- 偏移量 0xc2: TS=0x08 vs WASM=0x0a
- 偏移量 0xc3: TS=0x17 vs WASM=0x1b
- 偏移量 0xc4: TS=0x15 vs WASM=0x01
- 偏移量 0xc5: TS=0x1b vs WASM=0x17
- 偏移量 0xc6: TS=0x0e vs WASM=0x15
- 偏移量 0xc7: TS=0x20 vs WASM=0x1b
- 偏移量 0xc8: TS=0x08 vs WASM=0x0e
- 偏移量 0xc9: TS=0x17 vs WASM=0x20
- 偏移量 0xca: TS=0x15 vs WASM=0x08
- 偏移量 0xcb: TS=0x1b vs WASM=0x17
- 偏移量 0xcc: TS=0x0e vs WASM=0x15
- 偏移量 0xcd: TS=0x20 vs WASM=0x1b
- 偏移量 0xce: TS=0x08 vs WASM=0x0e
- 偏移量 0xcf: TS=0x17 vs WASM=0x20
- 偏移量 0xd0: TS=0x15 vs WASM=0x08
- 偏移量 0xd1: TS=0x1b vs WASM=0x17
- 偏移量 0xd2: TS=0x0e vs WASM=0x15
- 偏移量 0xd3: TS=0x25 vs WASM=0x1b
- ... (显示前20个差异，总共34个)
...
000000b0: 00 0e 06 2f c8 03 24 00 00 2f 0e 20 08 17 15 1b |.../..$../. ....|
000000c0: 0e 34 08 17 15 1b 0e 20 08 17 15 1b 0e 20 08 17 |.4..... ..... ..|
000000d0: 15 1b 0e 25 08 17 15 1b 0e 25 08 00 06 00 00 00 |...%.....%......|
000000e0: 00 00 00 f8 3f                                  |....?|
```
