...
- 偏移量 0x59: TS=0xff vs WASM=0xec
- 偏移量 0x5c: TS=0xca vs WASM=0xb7
- 偏移量 0x5d: TS=0xf6 vs WASM=0xe3
- 偏移量 0x66: TS=0x64 vs WASM=0x68
- 偏移量 0x69: TS=0xcb vs WASM=0xb8
- 偏移量 0x6b: TS=0x6d vs WASM=0xed
- 偏移量 0x6c: TS=0x29 vs WASM=0x19
- 偏移量 0x6d: TS=0x00 vs WASM=0x39
- 偏移量 0x6e: TS=0x00 vs WASM=0xe6
- 偏移量 0x70: TS=0x18 vs WASM=0x00
- 偏移量 0x77: TS=0x64 vs WASM=0x68
- 偏移量 0x7e: TS=0x64 vs WASM=0x68
- 偏移量 0x81: TS=0xcd vs WASM=0xba
- 偏移量 0x83: TS=0x6d vs WASM=0xed
- 偏移量 0x84: TS=0x12 vs WASM=0x08
- 偏移量 0x85: TS=0x00 vs WASM=0x68
- 偏移量 0x88: TS=0x64 vs WASM=0xbc
- 偏移量 0x89: TS=0x00 vs WASM=0xa5
- 偏移量 0x8a: TS=0x00 vs WASM=0xed
- 偏移量 0x8b: TS=0xcf vs WASM=0xd3
- ... (显示前20个差异，总共27个)
...
00000050: 01 00 36 00 ca 03 00 09 08 ff 02 29 ca f6 68 00 |..6........)..h.|
00000060: 00 93 69 00 00 0e 64 00 00 cb ad 6d 29 00 00 00 |..i...d....m)...|
00000070: 18 00 43 e7 00 00 00 64 00 00 24 01 00 0e 64 00 |..C....d..$...d.|
00000080: 00 cd ad 6d 12 00 00 00 64 00 00 cf a5 6d c8 03 |...m....d....m..|
00000090: 1a 00 00 22 08 11 02 1c 06 2a 04 13 0b 25 0e 1b |...".....*...%..|
000000a0: 0a 25 01 17 0d 2a 04 13 01 2a 04 00             |.%...*...*..|
```
