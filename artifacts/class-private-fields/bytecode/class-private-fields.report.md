...
**生成时间**: 2025-12-07T15:31:53.812Z

## 大小对比

- TypeScript编译器: 373 字节
- WASM编译器: 436 字节
- 差异: -63 字节 (-14.45%)
...
- 偏移量 0x36: TS=0x0c vs WASM=0x0e
- 偏移量 0x37: TS=0x23 vs WASM=0x43
- 偏移量 0x38: TS=0x63 vs WASM=0x6f
- 偏移量 0x39: TS=0x6f vs WASM=0x75
- 偏移量 0x3a: TS=0x75 vs WASM=0x6e
- 偏移量 0x3b: TS=0x6e vs WASM=0x74
- 偏移量 0x3c: TS=0x74 vs WASM=0x65
- 偏移量 0x3d: TS=0x0e vs WASM=0x72
- 偏移量 0x3e: TS=0x43 vs WASM=0x0c
- 偏移量 0x3f: TS=0x6f vs WASM=0x23
- 偏移量 0x40: TS=0x75 vs WASM=0x63
- 偏移量 0x41: TS=0x6e vs WASM=0x6f
- 偏移量 0x42: TS=0x74 vs WASM=0x75
- 偏移量 0x43: TS=0x65 vs WASM=0x6e
- 偏移量 0x44: TS=0x72 vs WASM=0x74
- 偏移量 0x6c: TS=0x01 vs WASM=0x03
- 偏移量 0x6f: TS=0x03 vs WASM=0x02
- 偏移量 0x70: TS=0x03 vs WASM=0x04
- 偏移量 0x71: TS=0x56 vs WASM=0x65
- 偏移量 0x72: TS=0x01 vs WASM=0x03
- ... (显示前20个差异，总共311个)
...
00000030: 6c 64 73 2e 6a 73 0c 23 63 6f 75 6e 74 0e 43 6f |lds.js.#count.Co|
00000040: 75 6e 74 65 72 02 63 12 69 6e 63 72 65 6d 65 6e |unter.c.incremen|
00000050: 74 0e 63 6f 6e 73 6f 6c 65 06 6c 6f 67 0d c8 03 |t.console.log...|
00000060: 00 00 00 00 00 0c 20 06 01 a4 01 00 01 00 03 03 |...... .........|
00000070: 03 56 01 ca 03 00 00 30 cc 03 00 0d b8 05 00 0d |.V.....0........|
00000080: ce 03 02 0d 08 ec 02 29 63 ff ff 06 63 00 00 c2 |.......)c...c...|
00000090: 00 58 e6 00 00 00 00 05 e5 00 00 00 cc c2 01 56 |.X.............V|
000000a0: e8 00 00 00 00 c2 02 56 42 00 00 00 01 cb 6b 00 |.......VB.....k.|
000000b0: 00 5c ff ff e3 e5 68 02 00 43 e8 00 00 00 24 00 |.\....h..C....$.|
000000c0: 00 0e 39 e9 00 00 00 43 ea 00 00 00 68 02 00 42 |..9....C....h..B|
000000d0: 42 00 00 00 24 01 00 0e 06 2f c8 03 14 00 00 00 |B...$..../......|
000000e0: 32 14 00 11 02 1b 14 17 15 1b 0e 1b 0a 11 02 1b |2...............|
000000f0: 03 00 0c 03 04 01 cc 03 00 01 00 03 02 00 22 01 |..............".|
00000100: 10 00 00 10 b8 05 01 0c ca 03 01 0d 08 cb 2b c7 |..............+.|
00000110: 68 01 00 b7 47 68 00 00 11 ec 06 c7 1b 24 00 00 |h...Gh.......$..|
00000120: 0e 68 00 00 11 ec 06 c7 1b 24 00 00 0e 29 c8 03 |.h.......$...)..|
00000130: 02 00 00 00 0c 00 00 00 d0 03 00 02 00 01 00 00 |................|
00000140: 07 02 10 00 00 10 b2 05 00 00 00 0c 04 cc 08 cb |................|
00000150: 0e 29 0c 00 00 00 84 01 00 02 00 01 00 00 0c 02 |.)..............|
00000160: 10 00 00 10 b2 05 00 00 00 0c 04 cc 08 cb 08 42 |...............B|
00000170: e5 00 00 00 28                                  |....(|
```
