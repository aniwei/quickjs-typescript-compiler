...
**输入文件**: __tests__/fixtures/optional-chaining.ts
**生成时间**: 2025-12-21T18:22:56.385Z

## 大小对比

- TypeScript编译器: 622 字节
- WASM编译器: 619 字节
- 差异: 3 字节 (0.48%)
...
- 偏移量 0x20a: TS=0x46 vs WASM=0x44
- 偏移量 0x215: TS=0x43 vs WASM=0x1b
- 偏移量 0x216: TS=0x0a vs WASM=0x08
- 偏移量 0x219: TS=0x1b vs WASM=0x43
- 偏移量 0x21a: TS=0x1d vs WASM=0x1b
- 偏移量 0x221: TS=0x43 vs WASM=0x1b
- 偏移量 0x222: TS=0x0a vs WASM=0x08
- 偏移量 0x224: TS=0x10 vs WASM=0x12
- 偏移量 0x225: TS=0x48 vs WASM=0x70
- 偏移量 0x226: TS=0x0e vs WASM=0x12
- 偏移量 0x228: TS=0x29 vs WASM=0x2d
- 偏移量 0x230: TS=0x0c vs WASM=0x08
- 偏移量 0x231: TS=0x2f vs WASM=0x07
- 偏移量 0x232: TS=0x08 vs WASM=0x0a
- 偏移量 0x233: TS=0x34 vs WASM=0x75
- 偏移量 0x234: TS=0x14 vs WASM=0x13
- 偏移量 0x235: TS=0x1b vs WASM=0x17
- 偏移量 0x236: TS=0x29 vs WASM=0x15
- 偏移量 0x237: TS=0x17 vs WASM=0x1b
- 偏移量 0x238: TS=0x15 vs WASM=0x0e
- ... (显示前20个差异，总共63个)
...
00000200: 00 00 00 24 01 00 cf 28 e4 03 46 00 00 00 46 12 |...$...(..F...F.|
00000210: 00 1b 0e 1b 0a 43 0a 43 12 1b 1d 17 15 1b 0e 1b |.....C.C........|
00000220: 0a 43 0a 43 10 48 0e 11 29 a9 15 1b 0e 1b 0a 48 |.C.C.H..)......H|
00000230: 0c 2f 08 34 14 1b 29 17 15 1b 0e 1b 0a 48 0c 2f |./.4..)......H./|
00000240: 08 43 10 39 25 17 15 1b 0e 1b 0a 43 0a 43 12 1b |.C.9%......C.C..|
00000250: 1d 00 0c 4a 07 00 d4 03 00 00 00 01 00 00 06 00 |...J............|
00000260: 04 f3 00 00 00 28 e4 03 04 04 08 1c 08 00       |.....(........|
```
