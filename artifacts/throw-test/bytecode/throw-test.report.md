...
- 偏移量 0x36: TS=0x02 vs WASM=0x6f
- 偏移量 0x37: TS=0x65 vs WASM=0x77
- 偏移量 0x70: TS=0x00 vs WASM=0x01
- 偏移量 0x72: TS=0x03 vs WASM=0x05
- 偏移量 0x75: TS=0x38 vs WASM=0x32
- 偏移量 0x76: TS=0x00 vs WASM=0x01
- 偏移量 0x79: TS=0x00 vs WASM=0x03
- 偏移量 0x7a: TS=0x01 vs WASM=0x00
- 偏移量 0x7b: TS=0x08 vs WASM=0x03
- 偏移量 0x7c: TS=0xec vs WASM=0xcc
- ... (显示前20个差异，总共122个)
...
00000030: 74 54 68 72 6f 77 02 65 0e 63 6f 6e 73 6f 6c 65 |tThrow.e.console|
...
00000070: 00 00 03 01 01 38 00 ca 03 00 01 08 ec 05 c2 00 |.....8..........|
00000080: e3 29 6f 0d 00 00 00 df f0 0e 0e 6e 25 00 00 00 |.)o........n%...|
00000090: cc 6f 1e 00 00 00 39 e7 00 00 00 43 e8 00 00 00 |.o....9....C....|
000000a0: 04 e9 00 00 00 c8 24 02 00 0e 0e 6e 05 00 00 00 |......$....n....|
000000b0: 30 06 2f c8 03 00 0c 12 00 00 04 04 00 1c 04 4f |0./............O|
000000c0: 00 34 0c 00 0c 42 06 00 ca 03 00 00 00 03 00 00 |.4...B..........|
000000d0: 0f 00 39 9f 00 00 00 04 ea 00 00 00 21 01 00 30 |..9.........!..0|
000000e0: 29 c8 03 00 04 04 0e 1b 06 00                   |).........|
```
