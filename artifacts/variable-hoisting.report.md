...
**输入文件**: __tests__/compiler/fixtures/variable-hoisting.ts
**生成时间**: 2025-12-02T17:07:51.353Z
...
- 偏移量 0x3b: TS=0x14 vs WASM=0x56
- 偏移量 0x3c: TS=0x68 vs WASM=0x61
- 偏移量 0x3d: TS=0x6f vs WASM=0x72
- 偏移量 0x3e: TS=0x69 vs WASM=0x0e
- 偏移量 0x3f: TS=0x73 vs WASM=0x63
- 偏移量 0x40: TS=0x74 vs WASM=0x6f
- 偏移量 0x41: TS=0x65 vs WASM=0x6e
- 偏移量 0x42: TS=0x64 vs WASM=0x73
- 偏移量 0x43: TS=0x56 vs WASM=0x6f
- 偏移量 0x44: TS=0x61 vs WASM=0x6c
- 偏移量 0x45: TS=0x72 vs WASM=0x65
- 偏移量 0x71: TS=0x2e vs WASM=0x2a
- 偏移量 0x73: TS=0xcc vs WASM=0xca
- 偏移量 0x7c: TS=0xe5 vs WASM=0xe6
- ... (显示前20个差异，总共67个)
...
00000030: 2e 6a 73 0e 63 6f 6e 73 6f 6c 65 14 68 6f 69 73 |.js.console.hois|
00000040: 74 65 64 56 61 72 06 6c 6f 67 24 49 20 61 6d 20 |tedVar.log$I am |
...
00000070: 00 2e 00 cc 03 00 01 08 ec 02 29 39 e5 00 00 00 |..........)9....|
00000080: 43 e7 00 00 00 39 e6 00 00 00 24 01 00 0e 04 e8 |C....9....$.....|
00000090: 00 00 00 e3 39 e5 00 00 00 43 e7 00 00 00 df 24 |....9....C.....$|
000000a0: 01 00 0e 06 2f c8 03 12 00 00 17 00 1b 0e 1b 0a |..../...........|
000000b0: 1b 01 36 15 1b 0e 1b 0a 07 01 00                |..6........|
```
