...
- 偏移量 0x9f: TS=0x34 vs WASM=0x11
- 偏移量 0xa0: TS=0x18 vs WASM=0x01
- 偏移量 0xa1: TS=0x26 vs WASM=0x17
- 偏移量 0xa2: TS=0x17 vs WASM=0x15
- 偏移量 0xa3: TS=0x34 vs WASM=0x1b
- 偏移量 0xa4: TS=0x18 vs WASM=0x0e
- 偏移量 0xa5: TS=0x00 vs WASM=0x1b
- 偏移量 0xa7: TS=0x05 vs WASM=0x11
- 偏移量 0xa8: TS=0x00 vs WASM=0x01
- 偏移量 0xaa: TS=0x00 vs WASM=0x0a
- 偏移量 0xab: TS=0x80 vs WASM=0x05
- ... (显示前20个差异，总共30个)
...
00000090: 06 2f c8 03 10 00 00 16 14 12 02 0c 01 0d 13 34 |./.............4|
000000a0: 18 26 17 34 18 00 0a 05 00 00 00 80 00 0a 05 01 |.&.4............|
000000b0: 00 00 80 00                                     |....|
```
