...
**输入文件**: __tests__/fixtures/for-of-destructuring-rest-007.ts
**生成时间**: 2025-12-25T02:25:24.823Z
...
- 偏移量 0x67: TS=0xbb vs WASM=0xb7
- 偏移量 0xc6: TS=0x5e vs WASM=0x5a
- 偏移量 0x112: TS=0x42 vs WASM=0xeb
- 偏移量 0x113: TS=0x30 vs WASM=0x9f
- 偏移量 0x114: TS=0x00 vs WASM=0x64
- 偏移量 0x115: TS=0x00 vs WASM=0x01
- 偏移量 0x118: TS=0x64 vs WASM=0x9f
- 偏移量 0x119: TS=0x01 vs WASM=0x11
- 偏移量 0x11a: TS=0x00 vs WASM=0x3a
- 偏移量 0x11b: TS=0x9f vs WASM=0xe9
- 偏移量 0x11c: TS=0x9f vs WASM=0x00
- 偏移量 0x11d: TS=0x11 vs WASM=0x00
- 偏移量 0x11e: TS=0x3a vs WASM=0x00
- 偏移量 0x11f: TS=0xe9 vs WASM=0xcb
- 偏移量 0x120: TS=0x00 vs WASM=0x82
- 偏移量 0x122: TS=0x00 vs WASM=0xec
- 偏移量 0x123: TS=0xcb vs WASM=0xa4
- 偏移量 0x124: TS=0x82 vs WASM=0x0e
- 偏移量 0x125: TS=0x00 vs WASM=0x86
- 偏移量 0x126: TS=0xec vs WASM=0x39
- ... (显示前20个差异，总共83个)
...
00000060: 01 00 05 00 0a 00 00 bb 01 05 a6 01 00 00 00 c8 |................|
...
000000c0: 00 24 00 00 7f ee 5e 7f 82 00 0e cc 82 00 0e cd |.$....^.........|
...
00000110: 04 00 42 30 00 00 00 9f 64 01 00 9f 9f 11 3a e9 |..B0....d.....:.|
00000120: 00 00 00 cb 82 00 ec a0 0e 86 39 eb 00 00 00 43 |..........9....C|
00000130: ec 00 00 00 39 e9 00 00 00 24 01 00 cf 28 da 03 |....9....$...(..|
00000140: 2e 00 00 8f 2a 7c 00 1b 06 1b 10 00 34 02 0b 11 |....*|......4...|
00000150: 06 16 04 07 0a 16 04 21 43 1b 0a 11 08 11 08 1b |.......!C.......|
00000160: 0b 07 20 11 03 07 25 4a 0b 1b 0e 1b 0a 1b 01 00 |.. ...%J........|
```
