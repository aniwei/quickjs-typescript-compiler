...
**输入文件**: __tests__/compiler/fixtures/literals.ts
**生成时间**: 2025-12-04T18:00:38.496Z
...
- 偏移量 0x81: TS=0x06 vs WASM=0x12
- 偏移量 0x83: TS=0x1d vs WASM=0x00
- 偏移量 0x84: TS=0x01 vs WASM=0x2f
- 偏移量 0x85: TS=0x00 vs WASM=0x0e
- 偏移量 0x86: TS=0x0f vs WASM=0x20
- 偏移量 0x87: TS=0x01 vs WASM=0x08
- 偏移量 0x88: TS=0x00 vs WASM=0x17
- 偏移量 0x89: TS=EOF vs WASM=0x15
- 偏移量 0x8a: TS=EOF vs WASM=0x1b
- 偏移量 0x8b: TS=EOF vs WASM=0x0e
...
00000080: 03 06 00 1d 01 00 0f 01 00                      |.........|
```
