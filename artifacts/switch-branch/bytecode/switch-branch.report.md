...
- 偏移量 0x4b: TS=0x03 vs WASM=0x02
- 偏移量 0x63: TS=0x00 vs WASM=0x08
- 偏移量 0x64: TS=0x04 vs WASM=0x00
- 偏移量 0x66: TS=0x07 vs WASM=0x00
- 偏移量 0x67: TS=0x0b vs WASM=0x07
- 偏移量 0x68: TS=0x00 vs WASM=0x16
- 偏移量 0x6b: TS=0x42 vs WASM=0x14
- 偏移量 0x6c: TS=0x06 vs WASM=0x00
- 偏移量 0x6d: TS=0x00 vs WASM=0x0c
- 偏移量 0x6e: TS=0xca vs WASM=0x43
- 偏移量 0x6f: TS=0x03 vs WASM=0x06
- 偏移量 0x71: TS=0x00 vs WASM=0xca
- 偏移量 0x72: TS=0x01 vs WASM=0x03
- 偏移量 0x73: TS=0x03 vs WASM=0x01
- 偏移量 0x75: TS=0x00 vs WASM=0x01
- 偏移量 0x76: TS=0x22 vs WASM=0x03
- 偏移量 0x77: TS=0x01 vs WASM=0x00
- 偏移量 0x78: TS=0x84 vs WASM=0x00
- 偏移量 0x79: TS=0x01 vs WASM=0x15
...
00000040: 00 00 0c 20 06 01 a4 01 00 00 00 03 01 01 0d 00 |... ............|
00000050: ca 03 00 01 08 ec 05 c2 00 e3 29 df b8 f1 0e 06 |..........).....|
00000060: 2f c8 03 00 04 00 07 0b 00 00 0c 42 06 00 ca 03 |/..........B....|
00000070: 01 00 01 03 00 00 22 01 84 01 00 00 00 d3 11 b7 |......".........|
00000080: ad 6d 11 00 00 00 11 b8 ad 6d 0b 00 00 00 6e 0a |.m.......m....n.|
00000090: 00 00 00 d3 28 d3 b8 9f 28 d3 b8 a0 28 0e 29 c8 |....(...(...(.).|
000000a0: 03 00 10 03 0a 0d 7f 2c 00 3d 04 0e 00 07 08 13 |.......,.=......|
000000b0: 78 07 08 00                                     |x...|
```
