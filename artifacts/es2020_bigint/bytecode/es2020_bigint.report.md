...
**生成时间**: 2025-12-09T14:28:02.710Z

## 大小对比

- TypeScript编译器: 241 字节
- WASM编译器: 249 字节
- 差异: -8 字节 (-3.21%)
...
- 偏移量 0x56: TS=0x06 vs WASM=0x03
- 偏移量 0xcd: TS=0x22 vs WASM=0x2a
...
- 偏移量 0xe2: TS=0x11 vs WASM=0x1b
- 偏移量 0xe3: TS=0x01 vs WASM=0x0e
- 偏移量 0xe4: TS=0x17 vs WASM=0x1b
- 偏移量 0xe5: TS=0x13 vs WASM=0x0a
- ... (显示前20个差异，总共39个)
...
00000050: 01 a4 01 00 00 00 06 05 00 5c 00 ca 03 00 0d cc |.........\......|
...
000000c0: 00 00 68 04 00 24 01 00 0e 06 2f c8 03 22 00 00 |..h..$..../.."..|
000000d0: 16 14 21 00 21 00 11 08 11 03 0d 03 11 08 11 03 |..!.!...........|
000000e0: 0d 01 11 01 17 13 34 18 26 17 34 18 26 17 34 18 |......4.&.4.&.4.|
000000f0: 00                                              |.|
```
