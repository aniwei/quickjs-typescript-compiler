...
- 偏移量 0x1f9: TS=0x30 vs WASM=0x44
- 偏移量 0x200: TS=0x34 vs WASM=0x1b
- 偏移量 0x201: TS=0x18 vs WASM=0x0e
- 偏移量 0x202: TS=0x11 vs WASM=0x1b
- 偏移量 0x203: TS=0x08 vs WASM=0x0a
- 偏移量 0x204: TS=0x43 vs WASM=0x11
- 偏移量 0x205: TS=0x12 vs WASM=0x08
- 偏移量 0x206: TS=0x58 vs WASM=0x43
- 偏移量 0x207: TS=0x31 vs WASM=0x12
- 偏移量 0x208: TS=0x34 vs WASM=0x43
- 偏移量 0x209: TS=0x18 vs WASM=0x1b
- 偏移量 0x20a: TS=0x11 vs WASM=0x17
- 偏移量 0x20b: TS=0x08 vs WASM=0x15
- 偏移量 0x20c: TS=0x43 vs WASM=0x1b
- 偏移量 0x20d: TS=0x12 vs WASM=0x0e
- 偏移量 0x20e: TS=0xfd vs WASM=0x1b
- 偏移量 0x20f: TS=0x17 vs WASM=0x0a
- 偏移量 0x210: TS=0x17 vs WASM=0x11
- 偏移量 0x211: TS=0x19 vs WASM=0x08
- 偏移量 0x212: TS=0x34 vs WASM=0x43
- ... (显示前20个差异，总共90个)
...
000001f0: 00 24 01 00 0e 06 2f c8 03 30 00 00 00 2e 12 00 |.$..../..0......|
00000200: 34 18 11 08 43 12 58 31 34 18 11 08 43 12 fd 17 |4...C.X14...C...|
00000210: 17 19 34 18 3e 08 07 0a 8a 29 34 18 3e 08 07 0a |..4.>....)4.>...|
00000220: 43 10 76 39 34 18 11 08 43 12 00 0c 42 07 01 00 |C.v94...C...B...|
00000230: 00 00 00 01 00 00 06 00 04 f3 00 00 00 28 c8 03 |.............(..|
00000240: 04 04 08 1c 08 00                               |......|
```
