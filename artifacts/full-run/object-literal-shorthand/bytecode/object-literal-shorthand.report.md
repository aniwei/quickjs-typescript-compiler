...
- 偏移量 0x6f: TS=0x02 vs WASM=0x00
- 偏移量 0x75: TS=0x02 vs WASM=0x00
- 偏移量 0x78: TS=0x01 vs WASM=0x00
- 偏移量 0x79: TS=0x00 vs WASM=0x0d
- 偏移量 0x7a: TS=0x30 vs WASM=0xcc
- 偏移量 0x7b: TS=0xcc vs WASM=0x03
- 偏移量 0x7c: TS=0x03 vs WASM=0x01
- 偏移量 0x7d: TS=0x01 vs WASM=0x0d
- 偏移量 0x7e: TS=0x01 vs WASM=0x08
- 偏移量 0x7f: TS=0x30 vs WASM=0xec
- 偏移量 0x80: TS=0xca vs WASM=0x02
- 偏移量 0x81: TS=0x03 vs WASM=0x29
- 偏移量 0x82: TS=0x00 vs WASM=0xbf
- 偏移量 0x83: TS=0x0d vs WASM=0x2a
- 偏移量 0x84: TS=0xcc vs WASM=0xe3
- 偏移量 0x85: TS=0x03 vs WASM=0x0b
- 偏移量 0x86: TS=0x01 vs WASM=0x68
- 偏移量 0x87: TS=0x0d vs WASM=0x00
- 偏移量 0x88: TS=0x08 vs WASM=0x00
- 偏移量 0x89: TS=0xec vs WASM=0x4e
- ... (显示前20个差异，总共45个)
...
00000060: 0d c8 03 00 00 00 00 00 0c 20 06 01 a4 01 00 02 |......... ......|
00000070: 00 02 02 00 1d 02 ca 03 01 00 30 cc 03 01 01 30 |..........0....0|
00000080: ca 03 00 0d cc 03 01 0d 08 ec 02 29 bf 2a e3 0b |...........).*..|
00000090: 64 00 00 4e e5 00 00 00 04 e7 00 00 00 4e e8 00 |d..N.........N..|
000000a0: 00 00 e4 06 2f c8 03 02 00 00 00                |..../......|
```
