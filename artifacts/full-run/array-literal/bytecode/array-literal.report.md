...
- 偏移量 0x4b: TS=0x30 vs WASM=0x08
- 偏移量 0x4c: TS=0xca vs WASM=0xec
- 偏移量 0x4d: TS=0x03 vs WASM=0x02
- 偏移量 0x4e: TS=0x00 vs WASM=0x29
- 偏移量 0x4f: TS=0x0d vs WASM=0xb8
- 偏移量 0x50: TS=0x08 vs WASM=0xb9
- 偏移量 0x51: TS=0xec vs WASM=0xba
- 偏移量 0x52: TS=0x02 vs WASM=0x26
- 偏移量 0x53: TS=0x29 vs WASM=0x03
- 偏移量 0x54: TS=0xb8 vs WASM=0x00
- 偏移量 0x55: TS=0xb9 vs WASM=0xe3
- 偏移量 0x56: TS=0xba vs WASM=0x06
- 偏移量 0x57: TS=0x26 vs WASM=0x2f
- 偏移量 0x58: TS=0x03 vs WASM=0xc8
- 偏移量 0x59: TS=0x00 vs WASM=0x03
- 偏移量 0x5a: TS=0xe3 vs WASM=0x02
- ... (显示前20个差异，总共28个)
...
00000040: 01 00 03 01 00 0d 01 ca 03 01 00 30 ca 03 00 0d |...........0....|
00000050: 08 ec 02 29 b8 b9 ba 26 03 00 e3 06 2f c8 03 02 |...)...&..../...|
00000060: 00 00 00                                        |...|
```
