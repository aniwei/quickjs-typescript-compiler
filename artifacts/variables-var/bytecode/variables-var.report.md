...
- 偏移量 0x42: TS=0x3f vs WASM=0x4b
- 偏移量 0x49: TS=0x3f vs WASM=0x40
- 偏移量 0x4f: TS=0x3f vs WASM=0x40
- 偏移量 0x55: TS=0xb8 vs WASM=0x3f
- 偏移量 0x56: TS=0x3a vs WASM=0xe4
- 偏移量 0x57: TS=0xe4 vs WASM=0x00
- 偏移量 0x5b: TS=0x39 vs WASM=0x3f
- 偏移量 0x5c: TS=0xe6 vs WASM=0xe5
- 偏移量 0x60: TS=0x43 vs WASM=0x00
- 偏移量 0x61: TS=0xe7 vs WASM=0xb8
- 偏移量 0x62: TS=0x00 vs WASM=0x3a
- 偏移量 0x63: TS=0x00 vs WASM=0xe4
- 偏移量 0x65: TS=0x39 vs WASM=0x00
- 偏移量 0x66: TS=0xe4 vs WASM=0x00
- 偏移量 0x67: TS=0x00 vs WASM=0x39
- 偏移量 0x68: TS=0x00 vs WASM=0xe6
- 偏移量 0x6a: TS=0x24 vs WASM=0x00
- 偏移量 0x6b: TS=0x01 vs WASM=0x00
- 偏移量 0x6c: TS=0x00 vs WASM=0x43
- 偏移量 0x6d: TS=0xcb vs WASM=0xe7
- ... (显示前20个差异，总共74个)
...
00000040: 00 00 3f 01 a6 01 00 00 00 3f e4 00 00 00 00 3f |..?......?.....?|
00000050: e5 00 00 00 00 b8 3a e4 00 00 00 39 e6 00 00 00 |......:....9....|
00000060: 43 e7 00 00 00 39 e4 00 00 00 24 01 00 cb b9 3a |C....9....$....:|
00000070: e5 00 00 00 39 e6 00 00 00 43 e7 00 00 00 39 e5 |....9....C....9.|
00000080: 00 00 00 24 01 00 cf 28 d0 03 16 00 00 3e 10 07 |...$...(.....>..|
00000090: 07 1c 07 34 18 1b 17 17 10 07 07 1c 07 34 18 1b |...4.........4..|
000000a0: 17 00                                           |..|
```
