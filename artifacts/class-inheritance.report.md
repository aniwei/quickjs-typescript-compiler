...
**生成时间**: 2025-12-08T08:58:15.069Z

## 大小对比

- TypeScript编译器: 585 字节
- WASM编译器: 682 字节
- 差异: -97 字节 (-14.22%)
...
- 偏移量 0x97: TS=0x04 vs WASM=0x06
- 偏移量 0x98: TS=0x65 vs WASM=0x68
...
- 偏移量 0xd5: TS=0x06 vs WASM=0xc2
- 偏移量 0xd6: TS=0xcc vs WASM=0x02
- 偏移量 0xd7: TS=0x0e vs WASM=0x52
- 偏移量 0xd8: TS=0xcf vs WASM=0xcc
- 偏移量 0xd9: TS=0x6b vs WASM=0x0e
- 偏移量 0xda: TS=0x01 vs WASM=0xcf
- 偏移量 0xdb: TS=0x00 vs WASM=0x6b
- 偏移量 0xdc: TS=0xe3 vs WASM=0x01
- 偏移量 0xdd: TS=0x63 vs WASM=0x00
- 偏移量 0xde: TS=0x02 vs WASM=0xe3
- 偏移量 0xdf: TS=0x00 vs WASM=0x63
- 偏移量 0xe0: TS=0x06 vs WASM=0x02
- ... (显示前20个差异，总共428个)
...
00000090: a4 01 00 04 00 05 03 04 65 04 ca 03 02 00 30 f0 |........e.....0.|
000000a0: 01 03 01 70 cc 03 02 01 30 f0 01 04 03 70 ca 03 |...p....0....p..|
...
000000e0: 06 63 03 00 68 00 00 c1 02 58 e6 00 00 00 01 c2 |.c..h....X......|
000000f0: 03 56 e8 00 00 00 00 06 ce 0e d1 6b 03 00 e4 68 |.V.........k...h|
00000100: 01 00 11 04 e9 00 00 00 04 ea 00 00 00 21 02 00 |.............!..|
00000110: e5 68 02 00 43 e8 00 00 00 24 00 00 0e 06 2f c8 |.h..C....$..../.|
00000120: 03 12 00 00 00 2a 12 24 11 23 00 18 16 1c 5d 1b |.....*.$.#....].|
00000130: 11 02 1b 0c 00 0c 42 07 01 00 01 01 01 02 01 00 |......B.........|
00000140: 1b 02 70 00 01 00 10 00 01 00 f0 01 01 0d 08 cb |..p.............|
00000150: 2b 68 00 00 11 ec 06 c7 1b 24 00 00 0e c7 39 38 |+h.......$....98|
00000160: 00 00 00 44 38 00 00 00 29 c8 03 06 02 04 4e 08 |...D8...).....N.|
00000170: 07 18 00 0c 00 00 00 d0 03 00 02 00 03 00 00 19 |................|
00000180: 02 10 00 00 10 ea 01 00 01 00 0c 04 cc 08 cb 39 |...............9|
00000190: eb 00 00 00 43 ec 00 00 00 04 ed 00 00 00 24 01 |....C.........$.|
000001a0: 00 0e 29 0c 46 07 01 00 02 03 02 04 01 00 33 05 |..).F.........3.|
000001b0: 70 00 01 00 d2 03 00 01 00 e8 01 00 01 00 e6 01 |p...............|
000001c0: 00 01 00 10 00 02 00 f0 01 03 0d 0c 02 cb 0c 03 |................|
000001d0: cc 63 02 00 2b c7 35 c8 39 38 00 00 00 21 01 00 |.c..+.5.98...!..|
000001e0: 11 66 02 00 68 00 00 11 ec 09 64 02 00 1b 24 00 |.f..h.....d...$.|
000001f0: 00 0e 0e 0e 5a 02 00 d4 44 e9 00 00 00 29 c8 03 |....Z...D....)..|
00000200: 0a 0b 04 35 08 11 0c 8f 0b 11 1a 00 0c 00 00 00 |...5............|
00000210: d0 03 00 02 00 03 00 00 26 02 10 00 00 10 ea 01 |........&.......|
00000220: 00 01 00 0c 04 cc 08 cb c7 c8 35 04 e8 00 00 00 |..........5.....|
00000230: 48 24 00 00 0e 39 eb 00 00 00 43 ec 00 00 00 04 |H$...9....C.....|
00000240: ef 00 00 00 24 01 00 0e 29                      |....$...)|
```
