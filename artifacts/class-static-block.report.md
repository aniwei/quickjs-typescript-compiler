...
**输入文件**: __tests__/fixtures/class-static-block.ts
**生成时间**: 2025-12-23T03:16:22.798Z

## 大小对比

- TypeScript编译器: 641 字节
- WASM编译器: 642 字节
- 差异: -1 字节 (-0.16%)
...
- 偏移量 0x1c5: TS=0x04 vs WASM=0x02
- 偏移量 0x1c7: TS=0x17 vs WASM=0x15
- 偏移量 0x1e8: TS=0x04 vs WASM=0x0b
- 偏移量 0x1ea: TS=0x20 vs WASM=0x10
- 偏移量 0x1ec: TS=0x17 vs WASM=0x15
- 偏移量 0x22f: TS=0x09 vs WASM=0xc7
- 偏移量 0x230: TS=0xc7 vs WASM=0x68
- 偏移量 0x231: TS=0x68 vs WASM=0x00
- 偏移量 0x233: TS=0x00 vs WASM=0xb7
- 偏移量 0x234: TS=0xb7 vs WASM=0x47
- 偏移量 0x235: TS=0x47 vs WASM=0xc7
- 偏移量 0x236: TS=0xc7 vs WASM=0x04
- 偏移量 0x237: TS=0x04 vs WASM=0xec
- 偏移量 0x238: TS=0xec vs WASM=0x00
- 偏移量 0x23b: TS=0x00 vs WASM=0x4e
- 偏移量 0x23c: TS=0x4e vs WASM=0xea
- 偏移量 0x23d: TS=0xea vs WASM=0x00
- 偏移量 0x240: TS=0x00 vs WASM=0xc2
- 偏移量 0x241: TS=0xc7 vs WASM=0x00
- 偏移量 0x242: TS=0xc2 vs WASM=0xc7
- ... (显示前20个差异，总共45个)
...
000001c0: 07 08 0c 0c 1c 04 0c 17 00 0c 42 07 01 00 00 01 |..........B.....|
000001d0: 00 02 01 00 06 01 10 00 01 00 ca 03 02 0d 08 cb |................|
000001e0: c7 df 45 28 d6 03 06 0e 04 12 20 0c 17 00 0c 40 |..E(...... ....@|
...
00000220: 04 01 01 1b 01 10 00 01 40 ca 03 02 0d 08 cb 09 |........@.......|
00000230: c7 68 00 00 b7 47 c7 04 ec 00 00 00 4e ea 00 00 |.h...G......N...|
00000240: 00 c7 c2 00 24 00 00 29 d6 03 02 00 00 00 0c 42 |....$..).......B|
00000250: 07 01 00 00 00 00 04 02 00 11 00 10 00 01 ca 03 |................|
00000260: 00 0c df b8 15 e0 46 df 04 ed 00 00 00 44 ea 00 |......F......D..|
00000270: 00 00 29 d6 03 0a 03 04 03 08 07 08 17 07 07 08 |..).............|
00000280: 00                                              |.|
```
