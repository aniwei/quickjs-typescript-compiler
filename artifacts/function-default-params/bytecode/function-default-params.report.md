...
- 偏移量 0x8f: TS=0x06 vs WASM=0x0a
- 偏移量 0x94: TS=0x12 vs WASM=0x07
- 偏移量 0x95: TS=0x00 vs WASM=0x0a
- 偏移量 0x96: TS=0x00 vs WASM=0x0d
- 偏移量 0x97: TS=0x0c vs WASM=0x09
- 偏移量 0x98: TS=0x41 vs WASM=0x20
- 偏移量 0x99: TS=0x06 vs WASM=0x0a
- 偏移量 0x9a: TS=0x01 vs WASM=0x00
- 偏移量 0x9b: TS=0xca vs WASM=0x0c
- 偏移量 0x9c: TS=0x03 vs WASM=0x41
- 偏移量 0x9d: TS=0x01 vs WASM=0x06
- 偏移量 0x9f: TS=0x00 vs WASM=0xca
- 偏移量 0xa0: TS=0x04 vs WASM=0x03
- 偏移量 0xa1: TS=0x00 vs WASM=0x01
- 偏移量 0xa2: TS=0x00 vs WASM=0x01
- 偏移量 0xa3: TS=0x24 vs WASM=0x00
- 偏移量 0xa4: TS=0x02 vs WASM=0x04
- 偏移量 0xa5: TS=0x70 vs WASM=0x00
- 偏移量 0xa7: TS=0x01 vs WASM=0x24
- 偏移量 0xa8: TS=0x00 vs WASM=0x02
- ... (显示前20个差异，总共76个)
...
00000080: df f0 0e df 04 e6 00 00 00 f1 0e 06 2f c8 03 06 |............/...|
00000090: 00 00 28 00 12 00 00 0c 41 06 01 ca 03 01 01 00 |..(.....A.......|
000000a0: 04 00 00 24 02 70 00 01 00 70 01 ff ff ff ff 0f |...$.p...p......|
000000b0: 20 63 00 00 d3 11 f4 ec 09 0e 04 e7 00 00 00 db | c..............|
000000c0: cb 39 e8 00 00 00 43 e9 00 00 00 04 ea 00 00 00 |.9....C.........|
000000d0: d3 24 02 00 29 c8 03 06 00 00 53 08 4d 2a 00    |.$..).....S.M*.|
```
