...
- 偏移量 0x8d: TS=0x00 vs WASM=0x16
- 偏移量 0x8e: TS=0x0a vs WASM=0x00
- 偏移量 0x8f: TS=0x16 vs WASM=0x00
- 偏移量 0x90: TS=0x0b vs WASM=0x21
- 偏移量 0x91: TS=0x0d vs WASM=0x00
- 偏移量 0x92: TS=0x75 vs WASM=0x1b
- 偏移量 0x93: TS=0x34 vs WASM=0x0e
- 偏移量 0x94: TS=0x13 vs WASM=0x1b
- 偏移量 0x95: TS=0x21 vs WASM=0x18
- 偏移量 0x96: TS=0x6d vs WASM=0x0c
- 偏移量 0x97: TS=0x34 vs WASM=0x0f
- 偏移量 0x98: TS=0x0c vs WASM=0x17
- 偏移量 0x99: TS=0x00 vs WASM=0x15
- 偏移量 0x9a: TS=EOF vs WASM=0x1b
- 偏移量 0x9b: TS=EOF vs WASM=0x0e
- 偏移量 0x9c: TS=EOF vs WASM=0x1b
- 偏移量 0x9d: TS=EOF vs WASM=0x0a
- 偏移量 0x9e: TS=EOF vs WASM=0x07
- 偏移量 0x9f: TS=EOF vs WASM=0x20
- ... (显示前20个差异，总共25个)
...
00000050: a4 01 00 00 00 03 01 00 2d 00 ca 03 00 01 08 ec |........-.......|
...
00000080: 9d 00 00 00 a9 24 01 00 0e 06 2f c8 03 00 0a 16 |.....$..../.....|
00000090: 0b 0d 75 34 13 21 6d 34 0c 00                   |..u4.!m4..|
```
