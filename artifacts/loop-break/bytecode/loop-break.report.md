...
- 偏移量 0x59: TS=0x1b vs WASM=0x25
- 偏移量 0x5a: TS=0x00 vs WASM=0x02
- 偏移量 0x5b: TS=0x08 vs WASM=0xca
- 偏移量 0x5c: TS=0xec vs WASM=0x03
- 偏移量 0x5e: TS=0x29 vs WASM=0x00
- 偏移量 0x5f: TS=0xb8 vs WASM=0x30
- 偏移量 0x60: TS=0xcb vs WASM=0xcc
- 偏移量 0x61: TS=0xb9 vs WASM=0x03
- 偏移量 0x62: TS=0xcc vs WASM=0x02
- 偏移量 0x63: TS=0x39 vs WASM=0x01
- 偏移量 0x64: TS=0xe7 vs WASM=0x30
- 偏移量 0x65: TS=0x00 vs WASM=0x08
- 偏移量 0x66: TS=0x00 vs WASM=0xec
- 偏移量 0x67: TS=0x00 vs WASM=0x02
- 偏移量 0x68: TS=0x43 vs WASM=0x29
- 偏移量 0x69: TS=0xe8 vs WASM=0x63
- 偏移量 0x6a: TS=0x00 vs WASM=0x01
- 偏移量 0x6c: TS=0x00 vs WASM=0x63
- ... (显示前20个差异，总共66个)
...
00000050: 01 a4 01 00 00 00 03 00 00 1b 00 08 ec 02 29 b8 |..............).|
00000060: cb b9 cc 39 e7 00 00 00 43 e8 00 00 00 c7 c8 9f |...9....C.......|
00000070: 24 01 00 0e 06 2f c8 03 00 08 17 10 0d 01 0d 71 |$..../.........q|
00000080: 34 0c 00                                        |4..|
```
