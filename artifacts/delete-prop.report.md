...
**输入文件**: __tests__/compiler/fixtures/delete-prop.ts
**生成时间**: 2025-12-07T03:40:15.808Z
...
- 偏移量 0x7b: TS=0x06 vs WASM=0x0a
- 偏移量 0x80: TS=0x54 vs WASM=0x11
- 偏移量 0x81: TS=0x00 vs WASM=0x06
- 偏移量 0x82: TS=0x00 vs WASM=0x45
- 偏移量 0x83: TS=EOF vs WASM=0x05
- 偏移量 0x84: TS=EOF vs WASM=0x16
- 偏移量 0x85: TS=EOF vs WASM=0x06
- 偏移量 0x86: TS=EOF vs WASM=0x00
...
00000070: e4 68 01 00 b7 9a 0e 06 2f c8 03 06 00 00 3f 0e |.h....../.....?.|
00000080: 54 00 00                                        |T..|
```
