...
**生成时间**: 2025-12-26T03:49:30.171Z

## 大小对比

- TypeScript编译器: 390 字节
- WASM编译器: 382 字节
- 差异: 8 字节 (2.09%)
...
- 偏移量 0x1: TS=0x0b vs WASM=0x0a
- 偏移量 0x93: TS=0x02 vs WASM=0x0d
- 偏移量 0x94: TS=0x31 vs WASM=0xc8
- 偏移量 0x95: TS=0x0d vs WASM=0x03
- 偏移量 0x96: TS=0xc8 vs WASM=0x02
- 偏移量 0x97: TS=0x03 vs WASM=0xca
- 偏移量 0x98: TS=0x02 vs WASM=0x03
- 偏移量 0x99: TS=0xca vs WASM=0x02
- 偏移量 0x9a: TS=0x03 vs WASM=0xcc
- 偏移量 0x9b: TS=0x02 vs WASM=0x03
- 偏移量 0x9c: TS=0xcc vs WASM=0x02
- 偏移量 0x9d: TS=0x03 vs WASM=0x00
- 偏移量 0x9e: TS=0x02 vs WASM=0x00
- 偏移量 0x9f: TS=0x00 vs WASM=0x03
- 偏移量 0xa1: TS=0x03 vs WASM=0x00
- 偏移量 0xa2: TS=0x00 vs WASM=0xce
- 偏移量 0xa3: TS=0x00 vs WASM=0x03
- 偏移量 0xa4: TS=0xce vs WASM=0x00
- 偏移量 0xa5: TS=0x03 vs WASM=0x01
- 偏移量 0xa7: TS=0x01 vs WASM=0xd0
- ... (显示前20个差异，总共222个)
...
### TypeScript
```
00000000: 05 0b 52 5f 5f 74 65 73 74 73 5f 5f 2f 66 69 78 |..R__tests__/fix|
...
00000090: 04 59 61 02 31 0d c8 03 02 ca 03 02 cc 03 02 00 |.Ya.1...........|
000000a0: 00 03 00 00 ce 03 00 01 00 d0 03 00 02 00 d2 03 |................|
000000b0: 01 00 0c 20 06 01 a4 01 00 00 00 0f 05 02 41 00 |... ..........A.|
000000c0: ce 03 00 0c d0 03 01 0c d2 03 02 0c d4 03 00 01 |................|
000000d0: d6 03 01 01 08 ec 0a c2 00 e6 c2 01 61 04 00 29 |............a..)|
000000e0: 68 01 00 11 04 ec 00 00 00 01 2c c6 1b 09 26 01 |h.........,...&.|
000000f0: 00 68 00 00 11 04 ec 00 00 00 09 0a bf 0a e2 39 |.h.............9|
00000100: 47 00 00 00 60 04 00 07 ba 21 09 00 26 01 00 21 |G...`....!..&..!|
00000110: 03 00 0e 06 2f c8 03 12 00 00 00 0c 38 08 58 08 |..../.......8.X.|
00000120: 43 46 07 12 1b 16 1b 5b 1f 02 00 0c 43 06 01 d4 |CF.....[....C...|
00000130: 03 00 00 00 02 01 00 22 00 d2 03 02 0c 38 ed 00 |.......".....8..|
00000140: 00 00 99 04 1b 00 00 00 ac ec 06 68 00 00 f0 0e |...........h....|
00000150: 39 ed 00 00 00 04 ee 00 00 00 26 01 00 f1 29 c8 |9.........&...).|
00000160: 03 0e 21 00 03 1e 1b 06 30 13 11 2e 0e 35 43 04 |..!.....0....5C.|
00000170: 00 0c 43 06 01 d6 03 00 00 00 00 00 00 01 00 29 |..C............)|
00000180: c8 03 02 27 00 00                               |...'..|
```
