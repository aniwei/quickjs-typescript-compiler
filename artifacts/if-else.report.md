...
**输入文件**: __tests__/fixtures/if-else.ts
**生成时间**: 2025-12-16T11:47:23.488Z
...
- 偏移量 0x86: TS=0x1c vs WASM=0x12
- 偏移量 0x89: TS=0x11 vs WASM=0x67
- 偏移量 0x8a: TS=0x10 vs WASM=0x08
- 偏移量 0x8b: TS=0x1b vs WASM=0x20
- 偏移量 0x8c: TS=0x07 vs WASM=0x04
- 偏移量 0x8d: TS=0x26 vs WASM=0x12
- 偏移量 0x8e: TS=0x07 vs WASM=0x03
- 偏移量 0x8f: TS=0x25 vs WASM=0x37
- 偏移量 0x90: TS=0x08 vs WASM=0x00
- 偏移量 0x91: TS=0x25 vs WASM=0x2c
- 偏移量 0x92: TS=0x08 vs WASM=0x07
- 偏移量 0x94: TS=0x03 vs WASM=0x0e
- 偏移量 0x95: TS=0x30 vs WASM=0x1b
- 偏移量 0x96: TS=0x03 vs WASM=0x0a
- 偏移量 0x98: TS=0x08 vs WASM=0x01
- 偏移量 0x99: TS=0x9b vs WASM=0x00
- ... (显示前20个差异，总共30个)
...
00000080: 01 00 cf 28 ce 03 1c 00 00 11 10 1b 07 26 07 25 |...(.........&.%|
00000090: 08 25 08 1b 03 30 03 1b 08 9b 07 1b 08 81 0f 3e |.%...0.........>|
000000a0: 18 25 17 00                                     |.%..|
```
