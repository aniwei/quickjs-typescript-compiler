...
**输入文件**: __tests__/compiler/fixtures/if-else.ts
**生成时间**: 2025-12-06T17:26:03.138Z
...
- 偏移量 0x86: TS=0x00 vs WASM=0x16
- 偏移量 0x87: TS=0x15 vs WASM=0x04
- 偏移量 0x88: TS=0x0a vs WASM=0x12
- 偏移量 0x89: TS=0x07 vs WASM=0x03
- 偏移量 0x8a: TS=0x1b vs WASM=0x2d
- 偏移量 0x8b: TS=0x0e vs WASM=0x00
- 偏移量 0x8c: TS=0x1b vs WASM=0x22
- 偏移量 0x8d: TS=0x0a vs WASM=0x07
- 偏移量 0x8e: TS=0x11 vs WASM=0x1b
- 偏移量 0x8f: TS=0x01 vs WASM=0x0e
- 偏移量 0x90: TS=0x00 vs WASM=0x1b
- 偏移量 0x91: TS=EOF vs WASM=0x0a
- 偏移量 0x92: TS=EOF vs WASM=0x11
...
00000080: 03 0e 00 00 21 08 00 15 0a 07 1b 0e 1b 0a 11 01 |....!...........|
00000090: 00                                              |.|
```
