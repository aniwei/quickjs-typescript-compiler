...
**输入文件**: __tests__/fixtures/compute.ts
**生成时间**: 2025-12-20T18:42:41.356Z
...
- 偏移量 0x73: TS=0x00 vs WASM=0x0a
- 偏移量 0x75: TS=EOF vs WASM=0x00
- 偏移量 0x76: TS=EOF vs WASM=0x03
- 偏移量 0x77: TS=EOF vs WASM=0x16
- 偏移量 0x78: TS=EOF vs WASM=0x07
- 偏移量 0x79: TS=EOF vs WASM=0x08
- 偏移量 0x7a: TS=EOF vs WASM=0x07
- 偏移量 0x7b: TS=EOF vs WASM=0x03
- 偏移量 0x7c: TS=EOF vs WASM=0x07
- 偏移量 0x7d: TS=EOF vs WASM=0x11
- 偏移量 0x7e: TS=EOF vs WASM=0x00
...
00000060: 00 04 02 cc 03 00 00 00 ce 03 00 00 00 d3 d4 9f |................|
00000070: 28 ca 03 00 00                                  |(....|
```
...
00000070: 28 ca 03 0a 00 00 03 16 07 08 07 03 07 11 00    |(..............|
```