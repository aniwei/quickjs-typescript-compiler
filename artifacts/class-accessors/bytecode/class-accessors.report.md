...
**生成时间**: 2025-12-07T18:10:44.311Z

## 大小对比

- TypeScript编译器: 410 字节
- WASM编译器: 470 字节
- 差异: -60 字节 (-12.77%)
...
- 偏移量 0x80: TS=0x01 vs WASM=0x02
- 偏移量 0x85: TS=0x01 vs WASM=0x03
...
- 偏移量 0xb3: TS=0x06 vs WASM=0xc2
- 偏移量 0xb4: TS=0xcc vs WASM=0x03
- 偏移量 0xb5: TS=0x0e vs WASM=0x52
- 偏移量 0xb6: TS=0xcf vs WASM=0xcc
- 偏移量 0xb7: TS=0x6b vs WASM=0x0e
- 偏移量 0xb8: TS=0x01 vs WASM=0xcf
- 偏移量 0xb9: TS=0x00 vs WASM=0x6b
- 偏移量 0xba: TS=0xe3 vs WASM=0x01
- 偏移量 0xbb: TS=0xe4 vs WASM=0x00
- 偏移量 0xbc: TS=0x68 vs WASM=0xe3
- 偏移量 0xbd: TS=0x01 vs WASM=0x68
- ... (显示前20个差异，总共270个)
...
00000070: 0c 20 06 01 a4 01 00 02 00 03 02 03 4f 02 ca 03 |. ..........O...|
00000080: 01 00 30 f0 01 01 00 70 ca 03 00 0d cc 03 01 0d |..0....p........|
...
000000b0: 00 00 02 06 cc 0e cf 6b 01 00 e3 e4 68 01 00 bf |.......k....h...|
000000c0: 0a 44 42 00 00 00 0e 39 e7 00 00 00 43 e8 00 00 |.DB....9....C...|
000000d0: 00 68 01 00 42 42 00 00 00 24 01 00 0e 06 2f c8 |.h..BB...$..../.|
000000e0: 03 10 00 00 00 2c 18 00 3a 00 1b 0e 1b 0a 11 02 |.....,..:.......|
000000f0: 1b 03 00 0c 03 04 01 ca 03 00 01 00 02 02 00 1c |................|
00000100: 01 10 00 00 10 f0 01 01 0d f0 01 00 0c 08 cb 2b |...............+|
00000110: 68 01 00 11 ec 06 c7 1b 24 00 00 0e 68 01 00 11 |h.......$...h...|
00000120: ec 06 c7 1b 24 00 00 0e 29 c8 03 02 00 00 00 0c |....$...).......|
00000130: 00 00 00 84 01 00 02 00 03 00 00 1f 02 10 00 00 |................|
00000140: 10 ea 01 00 00 00 0c 04 cc 08 cb 39 e7 00 00 00 |...........9....|
00000150: 43 e8 00 00 00 04 e9 00 00 00 24 01 00 0e 08 42 |C.........$....B|
00000160: ea 00 00 00 28 0c 00 00 00 84 01 01 02 01 03 00 |....(...........|
00000170: 00 19 03 d6 03 00 01 00 10 00 00 10 ea 01 00 00 |................|
00000180: 00 0c 04 cc 08 cb 39 e7 00 00 00 43 e8 00 00 00 |......9....C....|
00000190: 04 ec 00 00 00 24 01 00 0e 29                   |.....$...)|
```
