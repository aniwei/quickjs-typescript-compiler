...
**输入文件**: __tests__/fixtures/test_try_catch7.ts
**生成时间**: 2025-12-30T14:35:34.902Z

## 大小对比

- TypeScript编译器: 620 字节
- WASM编译器: 644 字节
- 差异: -24 字节 (-3.73%)
...
- 偏移量 0x1: TS=0x12 vs WASM=0x13
- 偏移量 0xa0: TS=0x67 vs WASM=0x66
- 偏移量 0xa1: TS=0x08 vs WASM=0x02
- 偏移量 0xa2: TS=0x74 vs WASM=0x67
- 偏移量 0xa3: TS=0x66 vs WASM=0x08
- 偏移量 0xa4: TS=0x61 vs WASM=0x74
- 偏移量 0xa5: TS=0x67 vs WASM=0x66
- 偏移量 0xa6: TS=0x0c vs WASM=0x61
- 偏移量 0xa7: TS=0x00 vs WASM=0x67
- 偏移量 0xa8: TS=0x06 vs WASM=0x0c
- 偏移量 0xaa: TS=0xa4 vs WASM=0x06
- 偏移量 0xab: TS=0x01 vs WASM=0x00
- 偏移量 0xac: TS=0x00 vs WASM=0xa4
- 偏移量 0xad: TS=0x02 vs WASM=0x01
- 偏移量 0xaf: TS=0x03 vs WASM=0x02
- 偏移量 0xb1: TS=0x02 vs WASM=0x03
- 偏移量 0xb2: TS=0x3e vs WASM=0x00
- 偏移量 0xb4: TS=0xa6 vs WASM=0x3e
- 偏移量 0xb5: TS=0x01 vs WASM=0x02
- 偏移量 0xb6: TS=0x00 vs WASM=0xa6
- ... (显示前20个差异，总共421个)
...
### TypeScript
```
00000000: 05 12 02 65 0c 61 73 73 65 72 74 1e 74 65 73 74 |...e.assert.test|
...
000000a0: 67 08 74 66 61 67 0c 00 06 00 a4 01 00 02 00 03 |g.tfag..........|
000000b0: 00 02 3e 02 a6 01 00 00 00 c8 03 03 00 03 40 e5 |..>...........@.|
000000c0: 00 00 00 40 40 e6 00 00 00 40 c2 00 41 e5 00 00 |...@@....@..A...|
000000d0: 00 00 c2 01 41 e6 00 00 00 00 06 cb 6f 13 00 00 |....A.......o...|
000000e0: 00 39 e7 00 00 00 04 e8 00 00 00 f1 cb 0e ee 0b |.9..............|
000000f0: cc 6f 07 00 00 00 0e ee 02 30 c7 28 d2 03 08 00 |.o.......0.(....|
00000100: 00 00 23 24 08 34 18 00 0c 43 06 00 ca 03 03 01 |..#$.4...C......|
00000110: 03 04 00 00 79 04 d4 03 00 01 00 d6 03 00 01 00 |....y...........|
00000120: 68 00 01 00 9e 01 00 01 00 0c 01 cb c7 eb b8 ab |h...............|
00000130: ec 03 0a d8 d3 d4 ad ec 02 29 d3 f5 ed 2f d4 f5 |.........).../..|
00000140: ed 2b d3 99 04 4b 00 00 00 ab ec 21 d4 99 04 4b |.+...K.....!...K|
00000150: 00 00 00 ab ec 17 d3 43 39 00 00 00 24 00 00 d4 |.......C9...$...|
00000160: 43 39 00 00 00 24 00 00 ad ec 02 29 39 9f 00 00 |C9...$.....)9...|
00000170: 00 04 ec 00 00 00 d3 9f 04 ed 00 00 00 9f 04 ee |................|
00000180: 00 00 00 9f d4 9f 04 ed 00 00 00 9f d5 ec 10 04 |................|
00000190: ef 00 00 00 d5 9f 04 f0 00 00 00 9f ee 02 c3 9f |................|
000001a0: f1 30 d2 03 50 03 00 12 10 07 12 0c 10 12 21 0d |.0..P.........!.|
000001b0: 00 07 16 07 07 12 0d 08 00 07 0e 11 18 07 12 12 |................|
000001c0: 23 07 0e 2f 2c 07 12 30 59 07 0c 1b 12 11 0e 07 |#../,..0Y.......|
000001d0: 10 1b 12 11 29 12 29 08 04 34 44 07 03 20 12 20 |....).)..4D.. . |
000001e0: 0c 08 3f 07 03 20 16 08 31 2a 22 07 03 20 14 15 |..?.. ..1*".. ..|
000001f0: 0c 06 31 07 15 00 0c 43 06 00 cc 03 00 02 00 04 |..1....C........|
00000200: 00 00 48 02 e2 03 00 00 00 c8 03 05 00 03 c3 cb |..H.............|
00000210: 6f 17 00 00 00 6f 11 00 00 00 04 f2 00 00 00 96 |o....o..........|
00000220: 00 04 f3 00 00 00 30 30 cc 6f 11 00 00 00 c8 96 |......00.o......|
00000230: 00 0e 06 70 08 00 00 00 0e ee 0a 30 04 f4 00 00 |...p.......0....|
00000240: 00 96 00 71 39 e5 00 00 00 c7 04 f5 00 00 00 04 |...q9...........|
00000250: 19 00 00 00 f3 29 d2 03 12 16 00 04 08 41 14 3f |.....).......A.?|
00000260: 03 00 08 0e 03 4b 00 45 02 39 01 00             |.....K.E.9..|
```
