...
**输入文件**: /Users/aniwei/Desktop/workspaces/quickjs-typescript-compiler/__tests__/fixtures/async-await-promise-chain-no-top-level-await-025.ts
**生成时间**: 2025-12-25T17:57:14.649Z
...
```json
{
  ...
  "atoms": [
    ...
    },
    {
      ...
      "actualLength": 70,
      "isWideChar": 0,
      "string": "__tests__/fixtures/async-await-promise-chain-no-top-level-await-025.js",
      "offset": 8
    },
    {
      "index": 2,
...
### TypeScript
```
00000000: 05 08 0a 72 75 6e 32 35 8c 01 5f 5f 74 65 73 74 |...run25..__test|
...
00000040: 76 65 6c 2d 61 77 61 69 74 2d 30 32 35 2e 6a 73 |vel-await-025.js|
...
000000d0: 00 00 43 82 00 00 00 bf 19 24 01 00 cb 64 00 00 |..C......$...d..|
