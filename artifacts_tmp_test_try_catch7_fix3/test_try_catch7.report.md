...
**生成时间**: 2025-12-30T14:37:09.279Z

## 大小对比

- TypeScript编译器: 654 字节
- WASM编译器: 644 字节
- 差异: 10 字节 (1.55%)
...
- 偏移量 0x204: TS=0x64 vs WASM=0x5a
- 偏移量 0x213: TS=0x2e vs WASM=0x24
- 偏移量 0x237: TS=0x0e vs WASM=0xcc
- 偏移量 0x238: TS=0x06 vs WASM=0x6f
- 偏移量 0x239: TS=0x70 vs WASM=0x11
- 偏移量 0x23a: TS=0x20 vs WASM=0x00
- 偏移量 0x23d: TS=0x00 vs WASM=0xc8
- 偏移量 0x23e: TS=0x0e vs WASM=0x96
- 偏移量 0x23f: TS=0xee vs WASM=0x00
- 偏移量 0x240: TS=0x22 vs WASM=0x0e
- 偏移量 0x241: TS=0xcc vs WASM=0x06
- 偏移量 0x242: TS=0x6f vs WASM=0x70
- 偏移量 0x243: TS=0x11 vs WASM=0x0d
- 偏移量 0x247: TS=0xc8 vs WASM=0x0e
- 偏移量 0x248: TS=0x96 vs WASM=0xee
- 偏移量 0x249: TS=0x00 vs WASM=0x0f
- 偏移量 0x24a: TS=0x0e vs WASM=0x70
- 偏移量 0x24b: TS=0x06 vs WASM=0x05
- 偏移量 0x24c: TS=0x70 vs WASM=0x00
- 偏移量 0x24d: TS=0x0d vs WASM=0x00
- ... (显示前20个差异，总共78个)
...
00000200: 00 04 00 00 64 02 e2 03 00 00 00 c8 03 05 00 03 |....d...........|
00000210: c3 cb 6f 2e 00 00 00 6f 11 00 00 00 04 f2 00 00 |..o....o........|
00000220: 00 96 00 04 f3 00 00 00 30 70 05 00 00 00 30 04 |........0p....0.|
00000230: f4 00 00 00 96 00 71 0e 06 70 20 00 00 00 0e ee |......q..p .....|
00000240: 22 cc 6f 11 00 00 00 c8 96 00 0e 06 70 0d 00 00 |".o.........p...|
00000250: 00 0e ee 0f 70 05 00 00 00 30 04 f5 00 00 00 96 |....p....0......|
00000260: 00 71 39 e5 00 00 00 c7 04 f6 00 00 00 04 19 00 |.q9.............|
00000270: 00 00 f3 29 d2 03 16 16 00 04 08 41 14 3f 03 28 |...).......A.?.(|
00000280: 04 00 18 08 07 64 00 2c 0b 1b 0e 39 01 00       |.....d.,...9..|
```
