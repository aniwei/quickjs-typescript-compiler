...
```json
{
  ...
  "atoms": [
    ...
    },
    {
      ...
      "actualLength": 64,
      "isWideChar": 0,
      "string": "__tests__/fixtures/try-catch-finally-throw-instanceof-new-041.js",
      "offset": 32
    }
  ],
  "functionHeader": {
...
### TypeScript
```
00000000: 05 09 02 78 02 65 06 43 34 31 06 6f 75 74 06 62 |...x.e.C41.out.b|
...
00000050: 74 61 6e 63 65 6f 66 2d 6e 65 77 2d 30 34 31 2e |tanceof-new-041.|
...
000000d0: 42 e9 00 00 00 11 3a e7 00 00 00 cb 06 cb bf 29 |B.....:........)|
000000e0: be 9e b7 ad ec 04 bf 29 30 0e 06 70 34 00 00 00 |.......)0..p4...|
...
00000190: 08 cb c7 bf 29 44 e9 00 00 00 29 d8 03 06 01 00 |....)D....).....|
