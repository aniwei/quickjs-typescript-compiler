...
**生成时间**: 2025-12-25T03:14:00.428Z

## 大小对比

- TypeScript编译器: 686 字节
- WASM编译器: 685 字节
- 差异: 1 字节 (0.15%)
...
- 偏移量 0x7e: TS=0x80 vs WASM=0xff
- 偏移量 0x7f: TS=0x02 vs WASM=0x01
- 偏移量 0x151: TS=0x10 vs WASM=0x0f
- 偏移量 0x153: TS=0x11 vs WASM=0x43
- 偏移量 0x154: TS=0x42 vs WASM=0x6a
- 偏移量 0x155: TS=0x6a vs WASM=0x00
- 偏移量 0x158: TS=0x00 vs WASM=0x3b
- 偏移量 0x159: TS=0x3b vs WASM=0x6a
- 偏移量 0x15a: TS=0x6a vs WASM=0x00
- 偏移量 0x15d: TS=0x00 vs WASM=0x0e
- 偏移量 0x15e: TS=0x0e vs WASM=0xee
- 偏移量 0x15f: TS=0xee vs WASM=0x11
- 偏移量 0x160: TS=0x11 vs WASM=0x0e
- 偏移量 0x161: TS=0x0e vs WASM=0x0b
- 偏移量 0x162: TS=0x0b vs WASM=0xc2
- 偏移量 0x163: TS=0xc2 vs WASM=0x04
- 偏移量 0x164: TS=0x04 vs WASM=0x4f
- 偏移量 0x165: TS=0x4f vs WASM=0x6a
- 偏移量 0x166: TS=0x6a vs WASM=0x00
- 偏移量 0x169: TS=0x00 vs WASM=0x4e
- ... (显示前20个差异，总共311个)
...
00000070: 02 79 0c 00 06 00 a4 01 00 05 00 07 00 05 80 02 |.y..............|
...
00000150: ed 10 73 11 42 6a 00 00 00 3b 6a 00 00 00 0e ee |..s.Bj...;j.....|
00000160: 11 0e 0b c2 04 4f 6a 00 00 00 4e 6a 00 00 00 ee |.....Oj...Nj....|
00000170: e2 39 ea 00 00 00 43 eb 00 00 00 39 e7 00 00 00 |.9....C....9....|
...
000001a0: 69 0c 1c 20 08 72 03 16 04 12 1b 1b 0e 1b 02 1b |i.. .r..........|
000001b0: 0a 11 01 11 0f 29 1e 11 02 00 2b 08 2f 1b 0e 1b |.....)....+./...|
...
00000260: 00 03 01 00 0e 02 10 00 01 00 ea 01 00 01 00 ca |................|
00000270: 03 02 5d 0c 04 cc 08 cb ee 01 c7 68 00 00 b8 47 |..]........h...G|
00000280: 29 d8 03 02 00 00 00 0c 02 06 00 00 02 00 02 02 |)...............|
00000290: 00 00 04 02 dc 03 00 01 00 de 03 00 01 00 d3 d4 |................|
000002a0: 9f 28 d8 03 08 0b 17 02 14 07 08 07 03 00       |.(............|
```
