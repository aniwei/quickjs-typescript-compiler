...
**输入文件**: /Users/aniwei/Desktop/workspaces/quickjs-typescript-compiler/__tests__/fixtures/try-catch-finally-throw-instanceof-new-022.ts
**生成时间**: 2025-12-25T03:14:01.241Z
...
```json
{
  ...
  "atoms": [
    ...
    },
    {
      ...
      "actualLength": 64,
      "isWideChar": 0,
      "string": "__tests__/fixtures/try-catch-finally-throw-instanceof-new-022.js",
      "offset": 32
    }
  ],
  "functionHeader": {
...
- 偏移量 0x169: TS=0x25 vs WASM=0x07
- 偏移量 0x16b: TS=0x11 vs WASM=0x2f

## 十六进制转储对比

### TypeScript
```
00000000: 05 09 02 78 02 65 06 43 32 32 06 6f 75 74 06 62 |...x.e.C22.out.b|
...
00000050: 74 61 6e 63 65 6f 66 2d 6e 65 77 2d 30 32 32 2e |tanceof-new-022.|
...
000000d0: 42 e9 00 00 00 11 3a e7 00 00 00 cb 06 cb bf 16 |B.....:.........|
000000e0: be 9e b7 ad ec 04 bf 16 30 0e 06 70 34 00 00 00 |........0..p4...|
...
00000160: 02 58 00 0c 08 1c 0d 5a 14 25 04 11 20 0c 04 11 |.X.....Z.%.. ...|
00000170: 0c 91 4f 25 08 3b 0f 1b 0e 1b 0a 1b 01 00 0c 43 |..O%.;.........C|
00000180: 06 00 cc 03 00 01 00 02 00 00 0b 01 10 00 01 00 |................|
00000190: 08 cb c7 bf 16 44 e9 00 00 00 29 d8 03 06 01 00 |.....D....).....|
