...
// Generated at: 2025-12-16T03:37:15.809Z
...
// Compile options derived constants
export const compileOptions = 5
export const SHORT_OPCODES = true
export const JS_MODE_STRICT_DEFAULT = 1
export const bytecodeVersion = 5
export const firstAtomId = 228
...
// 临时 opcodes 按数值查找
// 注意: 临时 opcodes 的值与 SHORT_OPCODES 重叠，只在编译阶段使用
export const TEMP_OPCODE_BY_CODE: Record<number, OpcodeDefinition> = {
  [TempOpcode.OP_enter_scope]: { id: "enter_scope", size: 3, nPop: 0, nPush: 0, format: OpFormat.u16 },
  [TempOpcode.OP_leave_scope]: { id: "leave_scope", size: 3, nPop: 0, nPush: 0, format: OpFormat.u16 },
  [TempOpcode.OP_label]: { id: "label", size: 5, nPop: 0, nPush: 0, format: OpFormat.label },
  [TempOpcode.OP_scope_get_var_undef]: { id: "scope_get_var_undef", size: 7, nPop: 0, nPush: 1, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_get_var]: { id: "scope_get_var", size: 7, nPop: 0, nPush: 1, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_put_var]: { id: "scope_put_var", size: 7, nPop: 1, nPush: 0, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_delete_var]: { id: "scope_delete_var", size: 7, nPop: 0, nPush: 1, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_make_ref]: { id: "scope_make_ref", size: 11, nPop: 0, nPush: 2, format: OpFormat.atom_label_u16 },
  [TempOpcode.OP_scope_get_ref]: { id: "scope_get_ref", size: 7, nPop: 0, nPush: 2, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_put_var_init]: { id: "scope_put_var_init", size: 7, nPop: 0, nPush: 2, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_get_var_checkthis]: { id: "scope_get_var_checkthis", size: 7, nPop: 0, nPush: 1, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_get_private_field]: { id: "scope_get_private_field", size: 7, nPop: 1, nPush: 1, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_get_private_field2]: { id: "scope_get_private_field2", size: 7, nPop: 1, nPush: 2, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_put_private_field]: { id: "scope_put_private_field", size: 7, nPop: 2, nPush: 0, format: OpFormat.atom_u16 },
  [TempOpcode.OP_scope_in_private_field]: { id: "scope_in_private_field", size: 7, nPop: 1, nPush: 1, format: OpFormat.atom_u16 },
  [TempOpcode.OP_get_field_opt_chain]: { id: "get_field_opt_chain", size: 5, nPop: 1, nPush: 1, format: OpFormat.atom },
  [TempOpcode.OP_get_array_el_opt_chain]: { id: "get_array_el_opt_chain", size: 1, nPop: 2, nPush: 1, format: OpFormat.none },
  [TempOpcode.OP_set_class_name]: { id: "set_class_name", size: 5, nPop: 1, nPush: 1, format: OpFormat.u32 },
  [TempOpcode.OP_line_num]: { id: "line_num", size: 5, nPop: 0, nPush: 0, format: OpFormat.u32 },
}
